declare module "eris" {
  ...
  export class Client extends EventEmitter {
    ...
    public createChannel(guildID: string, name: string, type?: number, reason?: string, parent?: string): Promise<GuildChannel>;
  ...
  export class Guild extends Base {
    ...
    public dynamicIconURL(format: string, size: number): string;
    public createChannel(name: string, type: string, parent?: string): Promise<GuildChannel>;
    public createEmoji(
