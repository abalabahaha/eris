...
declare namespace Eris {
  ...
  export class Client extends EventEmitter {
    ...
    getChannel<T extends AnyChannel = AnyChannel>(channelID: string): T;
    ...
    getRESTChannel<T extends AnyChannel = AnyChannel>(channelID: string): Promise<T>;
    getRESTGuild(guildID: string, withCounts?: boolean): Promise<Guild>;
    getRESTGuildChannels<T extends AnyGuildChannel = AnyGuildChannel>(guildID: string): Promise<T[]>;
  ...
  export class Guild extends Base {
    ...
    getRESTChannels<T extends AnyGuildChannel = AnyGuildChannel>(): Promise<T[]>;
