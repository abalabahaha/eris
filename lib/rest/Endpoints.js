...
module.exports.COMMANDS =                                                   (id) => `/applications/${id}/commands`;
module.exports.GET_COMMAND =                                     (id, commandID) => `/applications/${id}/commands/${commandID}`;

module.exports.COMMAND_GUILD =                                     (id, guildID) => `/applications/${id}/guilds/${guildID}/commands`;
module.exports.GET_COMMAND_GUILD =                      (id, guildID, commandID) => `/applications/${id}/guilds/${guildID}/commands/${commandID}`;

module.exports.RESPONDIG_TO_A_INTERACTION =  (interaction_id, interaction_token) => `/interactions/${interaction_id}/${interaction_token}/callback`;

// FollowUP
module.exports.FOLLOW_UP_RESPONSE =          (application_id, interaction_token) => `/webhooks/${application_id}/${interaction_token}/messages/@original`;
module.exports.FOLLOW_UP_NEW =               (application_id, interaction_token) => `/webhooks/${application_id}/${interaction_token}`;
module.exports.FOLLOW_UP =       (application_id, interaction_token, message_id) => `/webhooks/${application_id}/${interaction_token}/messages/${message_id}`;
module.exports.FOLLOW_UP_ORIGINAL =          (application_id, interaction_token) => `/webhooks/${application_id}/${interaction_token}/messages/@original`;
...
module.exports.GUILD_CHANNELS_THREAD_ACTIVE =                        (channelID) => `/channels/${channelID}/threads/active`;
module.exports.GUILD_CHANNELS_ME_THREADS_ARCHIVED_PRIVATE =          (channelID) => `/channels/${channelID}/users/@me/threads/archived/private`;
module.exports.GUILD_CHANNELS_THREAD_ARCHIVED_PUBLIC =               (channelID) => `/channels/${channelID}/threads/archived/public`;
module.exports.GUILD_CHANNELS_THREAD_ARCHIVED_PRIVATE =               (channelID) => `/channels/${channelID}/threads/archived/private`;
module.exports.GUILD_CHANNELS_THREAD_MEMBERS =                       (channelID) => `/channels/${channelID}/thread-members`;
module.exports.GUILD_CHANNELS_CREATE_THREAD_MESSAGE =                       (channelID, messageID) => `/channels/${channelID}/messages/${messageID}/threads`;
module.exports.GUILD_CHANNELS_CREATE_THREAD_WITHOUT_MESSAGE =                       (channelID) => `/channels/${channelID}/threads`;
...
module.exports.GUILD_STICKER =                                          (guildID) => `/guilds/${guildID}/stickers`;
...
module.exports.GUILD_TEMPLATE =                                           (code) => `/guilds/template/${code}`;
...
module.exports.GUILD_MEMBER_AVATAR =                 (guildID, memberID, avatar) => `/guilds/${guildID}/users/${memberID}/avatars/${avatar}`;
...
module.exports.USER_BANNER =                                    (userID, banner) => `/banners/${userID}/${banner}`;
