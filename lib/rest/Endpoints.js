...
module.exports.APPLICATION_EMOJIS =                              (applicationID) => `/applications/${applicationID}/emojis`;
module.exports.APPLICATION_EMOJI =                      (applicationID, emojiID) => `/applications/${applicationID}/emojis/${emojiID}`;
...
module.exports.ENTITLEMENT =                      (applicationID, entitlementID) => `/applications/${applicationID}/entitlements/${entitlementID}`;
module.exports.ENTITLEMENT_CONSUME =              (applicationID, entitlementID) => `/applications/${applicationID}/entitlements/${entitlementID}/consume`;
module.exports.ENTITLEMENTS =                                    (applicationID) => `/applications/${applicationID}/entitlements`;
...
module.exports.POLL_ANSWER_VOTERS =                 (channelID, msgID, answerID) => `/channels/${channelID}/polls/${msgID}/answers/${answerID}`;
module.exports.POLL_END =                                     (channelID, msgID) => `/channels/${channelID}/polls/${msgID}/expire`;
module.exports.ROLE_CONNECTION_METADATA_RECORDS =                        (appID) => `/applications/${appID}/role-connections/metadata`;
module.exports.SKUS =                                            (applicationID) => `/applications/${applicationID}/skus`;
module.exports.SKU_SUBSCRIPTION =                        (skuID, subscriptionID) => `/skus/${skuID}/subscriptions/${subscriptionID}`;
module.exports.SKU_SUBSCRIPTIONS =                        (skuID)                => `/skus/${skuID}/subscriptions`;
module.exports.SOUNDBOARD_SOUND_GUILD =                       (guildID, soundID) => `/guilds/${guildID}/soundboard-sounds/${soundID}`;
module.exports.SOUNDBOARD_SOUNDS_DEFAULT =                                          "/soundboard-default-sounds";
module.exports.SOUNDBOARD_SOUNDS_GUILD =                               (guildID) => `/guilds/${guildID}/soundboard-sounds`;
module.exports.SOUNDBOARD_SOUNDS_SEND =                              (channelID) => `/channels/${channelID}/send-soundboard-sound`;
...
module.exports.SOUNDBOARD_SOUNDS =                                     (soundID) => `soundboard-sounds/${soundID}`;
