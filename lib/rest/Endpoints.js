...
module.exports.GUILD_SCHEDULED_EVENT =               (guildID, scheduledEventID) => `/guilds/${guildID}/scheduled-events/${scheduledEventID}/guild-scheduled-event-object}`;
module.exports.GUILD_SCHEDULED_EVENTS =                                (guildID) => `/guilds/${guildID}/scheduled-events`;
module.exports.GUILD_SCHEDULED_EVENT_USERS =         (guildID, scheduledEventID) => `/guilds/${guildID}/scheduled-events/${scheduledEventID}/guild-scheduled-event-object}/users`;
