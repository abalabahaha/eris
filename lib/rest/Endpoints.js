...
module.exports.GROUP_RECIPIENT =        (groupID, userID) => `/channels/${groupID}/recipients/${userID}`;
...
module.exports.GUILD_ME_NICK =                  (guildID) => `/guilds/${guildID}/members/@me/nick`;
...
module.exports.ME =                                          "/users/@me";
module.exports.ME_CHANNELS =                                 "/users/@me/channels";
module.exports.ME_GUILD =                       (guildID) => `/users/@me/guilds/${guildID}`;
module.exports.ME_RELATIONSHIP =                 (userID) => `/users/@me/relationships/${userID}`;
