...
class Client extends EventEmitter {
    ...
    * @arg {Number | String | String[]} [options.intents] An intent, list of intents, or raw bitmask value describing the intents to subscribe to. "presence" intent must be enabled on your application's page to be used.
    */
    constructor(token, options) {
        ...
        if(this.options.intents) {
            ...
            if(typeof this.options.intents === "string") {
                if(Constants.Intents[this.options.intents]) this.options.intents = Constants.Intents[this.options.intents];
            }
        }
