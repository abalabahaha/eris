...
class Client extends EventEmitter {
    ...
    */
    ...
    /**
    * Edit guild channel positions. Note that channel position numbers are grouped by type (category, text, voice) and that for each type the lowest position is at the top and the highest at the bottom.
    * @arg {String} guildID The ID of the guild
