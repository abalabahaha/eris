...
class Client extends EventEmitter {
   ...
   * @returns {Promise}
   */
  editChannelPosition(guildID, channelID, position, options = {}) {
    const guild = this.guilds.get(guildID);
    if (!guild) {
   ...
   * @arg {String} channelID The ID of the channel
   * @arg {String} guildID The ID of the guild (not required)
  ...
  getChannel(channelID, guildID) {
    ...
    if (guildID && this.guilds.get(guildID)) {
  ...
  joinVoiceChannel(guildID, channelID, options = {}) {
    const channel = this.getChannel(channelID, guildID);
    if (!channel) {
    ...
    return this.voiceConnections.join(guildID, channelID, options);
  }
  ...
  leaveVoiceChannel(guildID, channelID) {
    ...
    this.closeVoiceConnection(guildID);
  }
