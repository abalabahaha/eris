...
class Client extends EventEmitter {
   ...
   * Edit a guild member
   * @arg {String} guildID The ID of the guild
   * @arg {String} memberID The ID of the member (you can use "@me" if you are editing the bot user)
   * @arg {Object} options The properties to edit
   * @arg {String?} [options.avatar] The new avatar for the bot user for this guild, as a base64 data URI. Only available when editing the current bot user. Note: base64 strings alone are not base64 data URI strings
   * @arg {String?} [options.banner] The new banner for the bot user for this guild, as a base64 data URI. Only available when editing the current bot user. Note: base64 strings alone are not base64 data URI strings
   * @arg {String?} [options.bio] The new bio for the bot user for this guild. Only available when editing the current bot user
  ...
  /**
   * [DEPRECATED] Edit the bot's nickname in a guild. Use `editGuildMember` instead
   * @arg {String} guildID The ID of the guild
