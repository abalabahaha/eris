...
class Client extends EventEmitter {
    ...
    * @arg {Number} [content.components[].max_values] TODO Pending documentation
    * @arg {Number} [content.components[].min_values] TODO Pending documentation
    ...
    * @arg {Number} content.components[].type The type of component - If 1, it is a collection and a `components` array (nested) is required; if 2, it is a button; if 3, it is a dropdown
    ...
    * @arg {Number} [options.components[].max_values] TODO Pending documentation
    * @arg {Number} [options.components[].min_values] TODO Pending documentation
    ...
    * @arg {Number} options.components[].type The type of component - If 1, it is a collection and a `components` array (nested) is required; if 2, it is a button; if 3, it is a dropdown
