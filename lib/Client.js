...
class Client extends EventEmitter {
   ...
   * @arg {Object} options The properties to edit
   * @arg {String?} [options.avatar] The new avatar for the bot user for this guild, as a base64 data URI. Note: base64 strings alone are not base64 data URI strings
   * @arg {String?} [options.banner] The new banner for the bot user for this guild, as a base64 data URI. Note: base64 strings alone are not base64 data URI strings
   * @arg {String?} [options.bio] The new bio for the bot user for this guild
