...
class Client extends EventEmitter {
    ...
    * @arg {Boolean} [options.autoreconnect=true]  [DEPRECATED] Have Eris autoreconnect when connection is lost. This option has been moved under `options.gateway`
    * @arg {Boolean} [options.compress=false]  [DEPRECATED] Whether to request WebSocket data to be compressed or not. This option has been moved under `options.gateway`
    * @arg {Number} [options.connectionTimeout=30000]  [DEPRECATED] How long in milliseconds to wait for the connection to handshake with the server. This option has been moved under `options.gateway`
    ...
    * @arg {Object} [options.disableEvents]  [DEPRECATED] If disableEvents[eventName] is true, the WS event will not be processed. This can cause significant performance increase on large bots. [A full list of the WS event names can be found on the docs reference page](/Eris/docs/reference#ws-event-names). This option has been moved under `options.gateway`
    * @arg {Number} [options.firstShardID=0]  [DEPRECATED] The ID of the first shard to run for this client. This option has been moved under `options.gateway`
    * @arg {Object} [options.gateway] Options for gateway connections
    * @arg {Boolean} [options.gateway.autoreconnect=true] Have Eris autoreconnect when connection is lost
    ...
    * @arg {Object} [options.gateway.disableEvents] If disableEvents[eventName] is true, the WS event will not be processed. This can cause significant performance increase on large bots. [A full list of the WS event names can be found on the docs reference page](/Eris/docs/reference#ws-event-names)
    ...
    * @arg {Number | Array<String | Number>} [options.gateway.intents] A list of [intent names](/Eris/docs/reference), pre-shifted intent numbers to add, or a raw bitmask value describing the intents to subscribe to. Some intents, like `guildPresences` and `guildMembers`, must be enabled on your application's page to be used. By default, all non-privileged intents are enabled.
    ...
    * @arg {Number | String} [options.gateway.maxConcurrency=1] The number of shards that can start simultaneously. If "auto" Eris will use Discord's recommended shard concurrency.
    * @arg {Number | String} [options.gateway.maxShards=1] The total number of shards you want to run. If "auto" Eris will use Discord's recommended shard count.
    ...
    * @arg {Boolean} [options.getAllUsers=false]  [DEPRECATED] Get all the users in every guild. Ready time will be severely delayed. This option has been moved under `options.gateway`
    * @arg {Number} [options.guildCreateTimeout=2000]  [DEPRECATED] How long in milliseconds to wait for a GUILD_CREATE before "ready" is fired. Increase this value if you notice missing guilds. This option has been moved under `options.gateway`
    * @arg {Number | Array<String | Number>} [options.intents] [DEPRECATED] A list of [intent names](/Eris/docs/reference), pre-shifted intent numbers to add, or a raw bitmask value describing the intents to subscribe to. Some intents, like `guildPresences` and `guildMembers`, must be enabled on your application's page to be used. By default, all non-privileged intents are enabled. This option has been moved under `options.gateway`
    * @arg {Number} [options.largeThreshold=250]  [DEPRECATED] The maximum number of offline users per guild during initial guild data transmission. This option has been moved under `options.gateway`
    * @arg {Number} [options.lastShardID=options.maxShards - 1]  [DEPRECATED] The ID of the last shard to run for this client. This option has been moved under `options.gateway`
    ...
    * @arg {Number} [options.maxReconnectAttempts=Infinity]  [DEPRECATED] The maximum amount of times that the client is allowed to try to reconnect to Discord. This option has been moved under `options.gateway`
    * @arg {Number} [options.maxResumeAttempts=10]  [DEPRECATED] The maximum amount of times a shard can attempt to resume a session before considering that session invalid. This option has been moved under `options.gateway`
    * @arg {Number | String} [options.maxShards=1] The total number of shards you want to run. If "auto" Eris will use Discord's recommended shard count. This option has been moved under `options.gateway`
    ...
    * @arg {Function} [options.reconnectDelay]  [DEPRECATED] A function which returns how long the bot should wait until reconnecting to Discord. This option has been moved under `options.gateway`
    ...
    * @arg {Boolean} [options.seedVoiceConnections=false]  [DEPRECATED] Whether to populate bot.voiceConnections with existing connections the bot account has during startup. Note that this will disconnect connections from other bot sessions. This option has been moved under `options.gateway`
