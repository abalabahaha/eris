...
class Client extends EventEmitter {
     ...
     * @arg {Number} [options.rateLimitPerUser] The time in seconds a user has to wait before sending another message (does not affect bots or users with manageMessages/manageChannel permissions) (text/voice/stage/forum channels only)
     * @arg {String} [options.reason] The reason to be displayed in audit logs
     ...
     * @returns {Promise<CategoryChannel | TextChannel | TextVoiceChannel | ForumChannel>}
     */
     ...
     * @arg {Array<String>} [options.appliedTags] The IDs of the set of tags that have been applied to a thread in a forum channel (forum channels only, max 5)
     ...
     * @arg {String} [options.reason] The reason to be displayed in audit logs
     * @arg {Number} [options.type] The channel type of the thread to create. This property defaults to private thread (12), but it is recommended to explicitly set this property as this will be a required property in API v10
     * @arg {Object | Array<Object>} [file] A file object (or an Array of them)
     * @arg {Buffer} file.file A buffer containing file data
     * @arg {String} file.name What to name the file
     ...
     * @arg {String} options.name The thread channel name
     * @arg {Number} [options.rateLimitPerUser] The time in seconds a user has to wait before sending another message (does not affect bots or users with manageMessages/manageChannel permissions)
     * @arg {String} [options.reason] The reason to be displayed in audit logs
    ...
    createThreadWithoutMessage(channelID, options) {
        return this.createThread(channelID, options);
    }
     ...
     * @arg {Number} [options.autoArchiveDuration] The duration in minutes to automatically archive the thread after recent activity, either 60, 1440, 4320 or 10080 (thread channels only)
     * @arg {Array<Object>} [options.availableTags] The available tags that can be applied to threads within a forum channel (forum channels only, max 20)
