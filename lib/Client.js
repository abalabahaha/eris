...
class Client extends EventEmitter {
    ...
    * @arg {Number | Array<String>} [options.intents] A list of intents, or raw bitmask value describing the intents to subscribe to. "presence" intent must be enabled on your application's page to be used. By default, all but `guildPresences` and `guildMembers` are used.
    ...
    */
    constructor(token, options) {
        ...
        this.options = Object.assign({
            ...
            intents: Object.keys(Constants.Intents).filter((i) => i !== "guildPresences" && i !== "guildMembers"),
            largeThreshold: 250,
    ...
    * @arg {String} [content.messageReference] A message ID of a message in the supplied channel of which the message should be replied to. The reference message cannot be a system message.
    ...
    */
    createMessage(channelID, content, file) {
        if(content !== undefined) {
            ...
            if(content.messageReference) { // https://github.com/discord/discord-api-docs/pull/2118/files#r498722671
                content.message_reference = {channel_id: channelID, message_id: content.messageReference}; // https://github.com/discord/discord-api-docs/pull/2118/files#r498714392
            }
        } else if(!file) {
            return Promise.reject(new Error("No content, file, or embed"));
        }
