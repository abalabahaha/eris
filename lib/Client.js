...
class Client extends EventEmitter {
  ...
  createCommand(command, id) {
    if (command instanceof CommandBase) {
      return this.requestHandler.request('POST', Endpoints.COMMAND(id), true, command.toData).then((commandData) => new CommandBase(commandData));
    }
    return this.requestHandler.request('POST', Endpoints.COMMAND(id), true, command).then((commandData) => new CommandBase(commandData));
  }
  ...
  deleteCommands(command, id) {
    return this.requestHandler.request('DELETE', Endpoints.COMMAND(id), true).then((commandData) => new CommandList(commandData, this));
  }
   ...
   * @returns {PromiseLike<*> | Promise<*>}
   */
  updateCommands(command, id) {
    return this.requestHandler.request('PATCH', Endpoints.COMMAND(id), true).then((commandData) => new CommandList(commandData, this));
  }
   ...
   */
  getCommands(id) {
    return this.requestHandler.request('GET', Endpoints.COMMANDS(id), true).then((commandData) => new CommandList(commandData, this));
  }
