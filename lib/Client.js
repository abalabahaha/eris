...
module.exports = class Client extends EventEmitter {
    ...
    */
    constructor(token, options) {
        ...
        this.groupChannels = new Collection();
        this.guilds = new Collection();
        this.privateChannelMap = {};
        this.privateChannels = new Collection();
        this.guildShardMap = {};
    ...
    /**
     * Gets the shards
     * @returns {Collection<Shard>} The shard collection
     */
    get shards() {
        return this.ws.shards;
    }
     ...
     */
    getShard(index) {
        if (this.shards.size >= index)
            throw new SyntaxError(`You only have ${this.shards.size} shards.`);
