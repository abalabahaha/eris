...
class Client extends EventEmitter {
   ...
   */
  createGuildSticker(guildID, name, description, tags, file) {
    return this.requestHandler.request('POST', Endpoints.GUILD_STICKER(guildID), true, {
      name,
      description,
      tags,
      file
    }).then((sticker) => new StickerItem(sticker, this));
  }
