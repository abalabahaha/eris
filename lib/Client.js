...
class Client extends EventEmitter {
    ...
    */
    constructor(token, options) {
        ...
        if(this.options.hasOwnProperty("intents")) {
            ...
            //If no intents is specified, emit a warning and set intents to 0
            this.emit("warn", "[DEPRECATED] Intents was not specified when initiating the client. You will only recieve Interaction events. If you want this, set intents to 0 or an empty array to remove this warning.");
    ...
    */
    createGuildEvent(guildID, event) {
        return this.requestHandler.request("POST", Endpoints.GUILD_EVENT_CREATE(guildID), true, {
