...
class Client extends EventEmitter {
    ...
    * @arg {String} [options.defaultImageFormat=jpg] The default format to provide user avatars and guild icons in. Can be 'jpg', 'png', 'gif', or 'webp'
    * @arg {Number} [options.defaultImageSize=128] The default size to return user avatars and guild icons as. Can be 128, 256, 512, 1024, or 2048.
    */
    constructor(token, options) {
        ...
        if(!Constants.ImageSizes.includes(this.options.defaultImageSize)) {
