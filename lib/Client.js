...
class Client extends EventEmitter {
    ...
    */
    createMessage(channelID, content, file) {
        if((!content || (typeof content !== "string" && !content.content && !content.embed)) && !file) {
    ...
    */
    editMessage(channelID, messageID, content) {
        if(!content || (typeof content !== "string" && !content.content && !content.embed)) {
