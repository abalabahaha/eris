...
const Soundboard = require("./structures/SoundboardSound");
...
class Client extends EventEmitter {
  ...
  createGuildSoundboardSound(guildID, options) { // NOTE Supports audit log reason
    options.emoji_id = options.emojiID;
    options.emoji_name = options.emojiName;
    return this.requestHandler.request("POST", Endpoints.SOUNDBOARD_SOUNDS_GUILD(guildID), true, options).then((sound) => new Soundboard(sound, this));
  }
  ...
  editGuildSoundboardSound(guildID, soundID, options) { // NOTE Supports audit log reason. All params optional
    options.emoji_id = options.emojiID;
    options.emoji_name = options.emojiName;
    return this.requestHandler.request("PATCH", Endpoints.SOUNDBOARD_SOUND_GUILD(guildID, soundID), true, options).then((sound) => new Soundboard(sound, this));
  }
  ...
  getGuildSoundboardSound(guildID, soundID) {
    return this.requestHandler.request("GET", Endpoints.SOUNDBOARD_SOUND_GUILD(guildID, soundID), true).then((sound) => new Soundboard(sound, this));
  }

  getGuildSoundboardSounds(guildID) {
    return this.requestHandler.request("GET", Endpoints.SOUNDBOARD_SOUNDS_GUILD(guildID), true).then((sounds) => sounds.map((sound) => new Soundboard(sound, this)));
  }
  ...
  getSoundboardSounds() {
    return this.requestHandler.request("GET", Endpoints.SOUNDBOARD_SOUNDS_DEFAULT, true).then((sounds) => sounds.map((sound) => new Soundboard(sound, this)));
  }

  /**
   * Get the stage instance associated with a stage channelgetG
