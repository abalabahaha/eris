...
class Client extends EventEmitter {
    ...
    * @arg {Record<string, string>} [command.nameLocalizations] Localizations of the command name, see [Valid Locales](https://discord.com/developers/docs/reference#locales)
    * @arg {String} [command.description] The command description (Slash Commands Only)
    * @arg {Record<string, string>} [command.descriptionLocalizations] Localizations of the command description, see [Valid Locales](https://discord.com/developers/docs/reference#locales)
    ...
    * @arg {Boolean | Array<String>} [options.allowedMentions.roles] Whether or not to allow all role mentions, or an array of specific role mentions to allow.
    * @arg {Boolean | Array<String>} [options.allowedMentions.users] Whether or not to allow all user mentions, or an array of specific user mentions to allow.
    * @arg {Array<Object>} [options.components] An array of component objects (the webhook must be created by a bot to use components)
    ...
    */
    getCommand(commandID, withLocalizations) {
        ...
        return this.requestHandler.request("GET", Endpoints.COMMAND(this.application.id, commandID) + (qs ? "?" + qs : ""), true);
    }
    ...
    */
    getCommands(withLocalizations) {
        ...
        return this.requestHandler.request("GET", Endpoints.COMMANDS(this.application.id) + (qs ? "?" + qs : ""), true);
    }
    ...
    */
    getGuildCommand(guildID, commandID, withLocalizations) {
        ...
        return this.requestHandler.request("GET", Endpoints.GUILD_COMMAND(this.application.id, guildID, commandID) + (qs ? "?" + qs : ""), true);
    }
    ...
    */
    getGuildCommands(guildID, withLocalizations) {
        ...
        return this.requestHandler.request("GET", Endpoints.GUILD_COMMANDS(this.application.id, guildID) + (qs ? "?" + qs : ""), true);
    }
