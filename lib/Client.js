...
class Client extends EventEmitter {
    ...
    * @param {Array<Object>} [options.welcomeChannels] The list of channels in the welcome screen. Each channel has the following properties: `channelID`, `description`, `emojiID`, `emojiName`. `emojiID` and `emojiName` properties can be null.
    * @returns {Promise<Object>}
    */
