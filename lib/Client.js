...
class Client extends EventEmitter {
    ...
    * @arg {Number} [options.requestTimeout=15000] [DEPRECATED] A number of milliseconds before requests are considered timed out. This option has been moved under `options.rest`
    ...
    * @arg {Number} [options.rest.requestTimeout=15000] A number of milliseconds before requests are considered timed out
