...
class Client extends EventEmitter {
    ...
    * @arg {String} [options.data.components[].custom_id] The ID of the component (type 2 style 0-4, type 3 and type 4 only)
    ...
    * @arg {String} [options.data.components[].label] The label to be displayed in the component (type 2 and type 4)
    ...
    * @arg {Number} [options.data.components[].max_length] The maximum input length for a text input, min 1, max 4000 (type 4)
    * @arg {Number} [options.data.components[].min_length] The minimum input length for a text input, min 0, max 4000 (type 4)
    ...
    * @arg {String} [options.data.components[].placeholder] The placeholder text for the component when no option is selected or the text input is empty (type 3 and 4)
    * @arg {Number} [options.data.components[].style] The style of the component (type 2 and type 4 only) - For buttons, if 0-4, `custom_id` is required; if 5, `url` is required, for text inputs 1-2
    ...
    * @arg {Boolean} [options.data.components[].required] Whether this component is required to be filled, default false (type 4)
    * @arg {String} [options.data.components[].value] A a pre-filled value for this component, max 4000 characters (type 4)
    ...
    * @arg {String} [content.components[].custom_id] The ID of the component (type 2 style 0-4, type 3 and type 4 only)
    ...
    * @arg {String} [content.components[].label] The label to be displayed in the component (type 2 and type 4)
    ...
    * @arg {Number} [content.components[].max_length] The maximum input length for a text input, min 1, max 4000 (type 4)
    * @arg {Number} [content.components[].min_length] The minimum input length for a text input, min 0, max 4000 (type 4)
    ...
    * @arg {String} [content.components[].placeholder] The placeholder text for the component when no option is selected or the text input is empty (type 3 and 4)
    * @arg {Number} [content.components[].style] The style of the component (type 2 and type 4 only) - For buttons, if 0-4, `custom_id` is required; if 5, `url` is required, for text inputs 1-2
    ...
    * @arg {Boolean} [content.components[].required] Whether this component is required to be filled, default false (type 4)
    * @arg {String} [content.components[].value] A a pre-filled value for this component, max 4000 characters (type 4)
    ...
    * @arg {String} [options.components[].custom_id] The ID of the component (type 2 style 0-4, type 3 and type 4 only)
    ...
    * @arg {String} [options.components[].label] The label to be displayed in the component (type 2 and type 4)
    ...
    * @arg {Number} [options.components[].max_length] The maximum input length for a text input, min 1, max 4000 (type 4)
    * @arg {Number} [options.components[].min_length] The minimum input length for a text input, min 0, max 4000 (type 4)
    ...
    * @arg {String} [options.components[].placeholder] The placeholder text for the component when no option is selected or the text input is empty (type 3 and 4)
    * @arg {Number} [options.components[].style] The style of the component (type 2 and type 4 only) - For buttons, if 0-4, `custom_id` is required; if 5, `url` is required, for text inputs 1-2
    ...
    * @arg {Boolean} [options.components[].required] Whether this component is required to be filled, default false (type 4)
    * @arg {String} [options.components[].value] A a pre-filled value for this component, max 4000 characters (type 4)
