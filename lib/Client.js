    ...
    */
    joinVoiceChannel(channelID) {
        ...
        if(connection) {
            ...
            var shard = this.shards.get(channel.guild && this.guildShardMap[guildID] || 0);
            connection = this.voiceConnections.add(new VoiceConnection(guildID, this.user.id, shard.sessionID, shard));
