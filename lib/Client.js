...
class Client extends EventEmitter {
    ...
    * @arg {Object} [options.presence] The initial presence information
    * @arg {Array<Object>} [options.presence.activities] A list of presence activities
    * @arg {String} options.presence.activities[].name The activity name
    * @arg {Number} [options.presence.activities[].type] The activity type, see `editStatus` method for possible values
    * @arg {String} [options.presence.activities[].url] The stream URL if the activity type is 1
    * @arg {Boolean} [options.presence.afk] Whether or not the client is AFK
    * @arg {Number?} [options.presence.since] Unix time of when the client is idle, or `null` if not idle
    * @arg {String} [options.presence.status] The initial status, see `editStatus` method for possible values
