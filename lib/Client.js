...
class Client extends EventEmitter {
    ...
    * @arg {String} [options.icon] The channel icon (group channels only)
    * @arg {String} [options.ownerID] The channel owner ID (group channels only)
    * @arg {String} [options.topic] The channel topic (guild text channels only)
    * @arg {Number} [options.bitrate] The channel bitrate (guild voice channels only)
    ...
    * @arg {Number} position The new channel position
    * @returns {Promise}
    */
    ...
    * @arg {String} guildID The ID of the guild the role is in
    * @arg {String} roleID The role ID
    * @arg {Number} position The new role position
    * @returns {Promise}
    */
