...
class Client extends EventEmitter {
    ...
    * @returns {Promise}
    */
    removeMessageReactionsForEmoji(channelID, messageID, reaction) {
        return this.requestHandler.request("DELETE", Endpoints.CHANNEL_MESSAGE_REACTIONS_EMOJI(channelID, messageID, reaction), true);
    }
