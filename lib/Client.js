...
class Client extends EventEmitter {
    ...
    * @returns {Promise<Object[]>} Resolves with an array of webhook object
    */
    getChannelWebhooks(channelID) {
        return this.requestHandler.request("GET", Constants.Endpoints.CHANNEL_WEBHOOKS(channelID), true);
    }
    ...
    */
    getWebhook(webhookID, token) {
        return this.requestHandler.request("GET", token ? Constants.Endpoints.WEBHOOK_TOKEN(webhookID, token) : Constants.Endpoints.WEBHOOK(webhookID), !token);
    }
    ...
    * @arg {String} options.username The default username
    ...
    */
    createWebhook(channelID, options) {
        return this.requestHandler.request("POST", Constants.Endpoints.CHANNEL_WEBHOOKS(channelID), true, options);
    }
    ...
    * @arg {String} webhookID The ID of the webhook
    * @arg {Object} options Webhook options
    * @arg {String} [options.username] The new default username
    ...
    */
    editWebhook(webhookID, options, token) {
        return this.requestHandler.request("PATCH", token ? Constants.Endpoints.WEBHOOK_TOKEN(webhookID, token) : Constants.Endpoints.WEBHOOK(webhookID), !token, options);
    }
    ...
    * @arg {String} options.file.file A readable stream or buffer
    ...
    */
    executeSlackWebhook(webhookID, token, options) {
        ...
        return this.requestHandler.request("POST", Constants.Endpoints.WEBHOOK_TOKEN_SLACK(webhookID, token) + (wait ? "?wait=true" : ""), true, options);
    }
    ...
    */
    deleteWebhook(webhookID, token) {
        return this.requestHandler.request("DELETE", token ? Constants.Endpoints.WEBHOOK_TOKEN(webhookID, token) : Constants.Endpoints.WEBHOOK(webhookID), !token);
    }
    ...
    */
    getGuildWebhooks(guildID) {
        return this.requestHandler.request("GET", Constants.Endpoints.GUILD_WEBHOOKS(guildID), true);
    }
