...
class Client extends EventEmitter {
    ...
    */
    ...
    /**
    * Add an array of reactions to a message
    * @arg {String} channelID The ID of the channel
    * @arg {String} messageID The ID of the message
    * @arg {String[]} reactions The array of reactions (Unicode string if Unicode emoji, `emojiName:emojiID` if custom emoji)
    * @arg {String} [userID="@me"] The ID of the user to react as
    * @returns {Promise}
    */
    addChainReaction(channelID, messageID, reactions, userID, topResolve, topReject) {
        return new Promise((resolve, reject) => {
            if(reactions.length > 0) {
                this.addMessageReaction.call(this, channelID, messageID, reactions[0]).then(() => {
                    this.addChainReaction.call(this, channelID, messageID, reactions.slice(1), userID, (topResolve || resolve), (topReject || reject));
                }).catch(err => {
                    (topReject || reject)(err);
                });
            } else {
                (topResolve || resolve)();
            }
