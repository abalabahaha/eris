...
class Client extends EventEmitter {
    ...
    */
    createGuildScheduledEvent(guildID, event) {
    ...
    * @arg {String} eventID The id of the guild scheduled event to be edited
    ...
    */
    getRESTGuildScheduledEvent(guildID, eventID) {
        ...
        return this.requestHandler.request("GET", Endpoints.GUILD_SCHEDULED_EVENT(guildID, eventID), true).then((data) => new GuildScheduledEvent(data, this));
    }
