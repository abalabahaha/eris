...
class Client extends EventEmitter {
  ...
  deleteCommands(command, id) {
    return this.requestHandler.request('DELETE', Endpoints.COMMANDS(id), true).then((commandData) => new CommandList(commandData, this));
  }
  ...
  updateCommands(command, id) {
    return this.requestHandler.request('PATCH', Endpoints.COMMANDS(id), true).then((commandData) => new CommandList(commandData, this));
  }
   ...
   */
  getCommands(id) {
    return this.requestHandler.request('GET', Endpoints.COMMANDS(id), true).then((commandData) => {
      const dataObject = new CommandList(commandData, this);
      this.emit('getCommandList', (dataObject));
      return dataObject;
    });
  }
