...
class Client extends EventEmitter {
    ...
    * @arg {Number} [options.data.flags] 64 for Ephemeral (applies to Application Commands and Message Components)
    ...
    */
    ...
    getGuildWidgetImageURL(guildID, style) {
        const styles = Object.values(Constants.GuildWidgetStyles);
        if(!styles.includes(style)) {
            style = "shield";
        }
        return `https://discord.com/api/v${Constants.REST_VERSION}/${Endpoints.GUILD_WIDGET_IMAGE(guildID)}?style=${style}`;
    }
