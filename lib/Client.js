...
class Client extends EventEmitter {
    ...
    * @returns {Promise<Message>}
    */
    createMessage(channelID, content, file, embed) {
        ...
        if(!content.content && !file && !(content.embed || embed)) {
        ...
        content.embed = content.embed || embed;
    ...
    */
    editMessage(channelID, messageID, content, embed) {
        ...
        if(!content.content && !(content.embed || embed)) {
