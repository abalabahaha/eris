...
class Client extends EventEmitter {
     ...
     * @arg {String} channelID The ID of the channel
     * @arg {String} msgID The ID of the message
     * @returns {Promise<Message>}
     */
    endPoll(channelID, msgID) {
        return this.requestHandler.request("POST", Endpoints.POLL_END(channelID, msgID), true).then((message) => new Message(message, this));
    }
     ...
     * @arg {String} channelID The ID of the channel
     * @arg {String} msgID The ID of the message
     * @arg {Number} answerID The ID of the answer
     * @arg {Object} [options] Options for the request
     * @arg {String} [options.after] Get users after this user ID
     * @arg {Number} [options.limit=25] The max number of users to get
     * @returns {Promise<Object>} An object with a `users` key, which is an array of user objects who voted for this answer
     */
