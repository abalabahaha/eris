...
class Client extends EventEmitter {
    ...
    * @arg {String} guildID The ID of the guild to create the emoji in
    * @arg {Object} options Emoji options
    * @arg {String} options.emojiID The ID of the emoji you want to modify
    * @arg {String} [options.name] The name of emoji
    * @arg {Array} [options.roles] An array containing authorized role IDs
    * @returns {Promise<Object>}
    */
    editGuildEmoji(guildID, options) {
      return this.requestHandler.request("PATCH", Constants.Endpoints.GUILD_EMOJI(guildID, options.emojiID), true, {
          name: options.name,
          roles: options.roles
      });
    }
