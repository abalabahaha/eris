...
class Client extends EventEmitter {
    ...
    */
    createMessage(channelID, content, file) {
        if(content !== undefined) {
            ...
            if(file) {
                this.emit("warn", "[DEPRECATED] file is deprecated. Use content.attachments instead");
    ...
    */
    editWebhookMessage(webhookID, token, messageID, options) {
        ...
        if(options.file) {
            this.emit("warn", "[DEPRECATED] options.file is deprecated. Use options.attachments instead");
