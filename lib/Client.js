...
class Client extends EventEmitter {
  ...
  createCommand(command) {
    return this.requestHandler.request('POST', Endpoints.COMMAND(this.bot.id), true).then((commandData) => new CommandBase(commandData));
  }
  ...
  deleteCommands(command) {
    return this.requestHandler.request('DELETE', Endpoints.COMMAND(this.bot.id), true).then((commandData) => new CommandList(commandData));
  }
  ...
  updateCommands(command) {
    return this.requestHandler.request('PATCH', Endpoints.COMMAND(this.bot.id), true).then((commandData) => new CommandList(commandData));
  }
   ...
   */
  getCommands(command) {
    return this.requestHandler.request('GET', Endpoints.COMMAND(this.bot.id), true).then((commandData) => new CommandList(commandData));
  }
