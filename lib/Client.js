...
const StickerData = require('./structures/StickerData');
const StickerItem = require('./structures/StickerItem');
...
const CommandBase = require('./slashcommand/CommandBase');
// eslint-disable-next-line no-unused-vars
const CommandList = require('./slashcommand/CommandList');
...
class Client extends EventEmitter {
  ...
  addVolumeOfCommands(command, id) {
    if (command instanceof CommandBase) {
      return this.requestHandler.request('PUT', Endpoints.COMMANDS(id), true, command).then((commandData) => new CommandBase(commandData));
    }
   ...
   */
  async callbackInteraction(interaction_id, interaction_token, data) {
    return this.requestHandler.request('POST', Endpoints.RESPONDIG_TO_A_INTERACTION(interaction_id, interaction_token), true, data);
  }
  /**
  ...
  createChannelInvite(channelID, options, reason) {
    return this.requestHandler.request('POST', Endpoints.CHANNEL_INVITES(channelID), true, options, reason).then((invite) => new Invite(invite, this));
  }
  /**
  ...
  createCommand(command, id) {
    if (command instanceof CommandBase) {
      return this.requestHandler.request('POST', Endpoints.COMMANDS(id), true, command.toJSON).then((commandData) => new CommandBase(commandData));
    }
   ...
   * @returns {PromiseLike<*> | Promise<*>}
   */
  createCommandGuild({ command,  guildID }) {
    if (command instanceof CommandBase) {
      return this.requestHandler.request('POST', Endpoints.COMMAND_GUILD(this.user.id, guildID), true, command.toJSON).then((commandData) => new CommandBase(commandData));
    }

    return this.requestHandler.request('POST', Endpoints.COMMAND_GUILD(this.user.id, guildID), true, command).then((commandData) => new CommandBase(commandData));
  }
   ...
   */
  createFollowUpMessage(application_id, interaction_token, data, file, interaction) {
    if (data?.file !== undefined) {
      return this.requestHandler.request('POST', Endpoints.FOLLOW_UP_NEW(application_id, interaction_token), true, data, data.file).then((message) => new MessageInteraction(message, this, interaction));
    }
    return this.requestHandler.request('POST', Endpoints.FOLLOW_UP_NEW(application_id, interaction_token), true, data).then((message) => new MessageInteraction(message, this, interaction));
  }
  /**
  ...
  /**
   * Create a sticker on the guild
   * @arg {String} guildID The ID of the guild
   * @arg {String} name The name of the sticker
   * @arg {String} description The description of the sticker
   * @arg {String} tags The Discord name of a unicode emoji representing the sticker's expression (2-200 characters)
   * @arg {Buffer} file The buffer of the sticker
   * @arg {String} [reason] The reason to be displayed in audit logs
   * @returns {Promise<StickerItem>}
   */

  createGuildSticker(guildID, options, reason) {
    if (options instanceof StickerData) {
      return this.requestHandler.request('POST', Endpoints.GUILD_STICKER(guildID), true, options).then((sticker) => new StickerItem(sticker));
    } else {
      options.reason = reason;
      return this.requestHandler.request('POST', Endpoints.GUILD_STICKER(guildID), true, options).then((sticker) => new StickerItem(sticker));
    }
  ...
  * @arg {Object} [content.embeds] An embed object. See [the official Discord API documentation entry](https://discord.com/developers/docs/resources/channel#embed-object) for object structure
  ...
  */
  createMessage(channelID, content, file) {
    if (content !== undefined) {
      ...
      } else if (content.content === undefined && !content.embeds && !file) {
  ...
  /**
    @description  >> need <<
    */
  createMessageThread(channelID, messageID, data) {
    if (!this.options.restMode) {
      return Promise.reject(new Error('Eris REST mode is not enabled'));
    }
    return this.requestHandler.request('POST', Endpoints.GUILD_CHANNELS_CREATE_THREAD_MESSAGE(channelID, messageID), true, data);
  }
  ...
  /**
    ...
    * @arg {Boolean} [options.icon] Icon in base64 encoding
    * @arg {Boolean} [options.unicode_emoji]
  ...
  /**
    @description  >> need <<
    */
  createThread(channelID, data) {
    if (!this.options.restMode) {
      return Promise.reject(new Error('Eris REST mode is not enabled'));
    }
    return this.requestHandler.request('POST', Endpoints.GUILD_CHANNELS_CREATE_THREAD_WITHOUT_MESSAGE(channelID), true, data);
  }
  /**
   ...
   * @returns {PromiseLike<*> | Promise<*>}
   */
  deleteCommands(command, id) {
    return this.requestHandler.request('DELETE', Endpoints.COMMANDS(id), true).then((commandData) => new CommandBase(commandData));
  }
   ...
   * @returns {PromiseLike<*> | Promise<*>}
   */
  deleteCommandsGuild({ commandID, guildID }) {
    return this.requestHandler.request('DELETE', Endpoints.GET_COMMAND_GUILD(this.user.id, guildID, commandID), true).then((commandData) => new CommandBase(commandData));
  }

  deleteFollowUpMessage(interaction_id, interaction_token) {
    return this.requestHandler.request('DELETE', Endpoints.FOLLOW_UP_RESPONSE(interaction_id, interaction_token), true);
  }
  /**
   ...
   * @returns {Promise<MessageInteraction>}
   */
  editFollowUpMessage(application_id, interaction_token, data, file, interaction) {
    if (data?.file !== undefined) {
      return this.requestHandler.request('PATCH', Endpoints.FOLLOW_UP_ORIGINAL(application_id, interaction_token), true, data, data.file).then((message) => new MessageInteraction(message, this, interaction));
    }
    if (file !== undefined) {
      return this.requestHandler.request('PATCH', Endpoints.FOLLOW_UP_ORIGINAL(application_id, interaction_token), true, data, file).then((message) => new MessageInteraction(message, this, interaction));
    }
    return this.requestHandler.request('PATCH', Endpoints.FOLLOW_UP_ORIGINAL(application_id, interaction_token), true, data).then((message) => new MessageInteraction(message, this, interaction));
  }
  /**
    * Edit a guild
    * @arg {String} guildID The ID of the guild
  ...
  /**
    ...
    * @arg {String} [option.communicationDisabledUntil] The time of the user who will be timeouted
  ...
  /**
    ...
    * @returns {Promise<Message>}
    */
  editMessage(channelID, messageID, content, file) {
    if (content !== undefined) {
      if (typeof content !== 'object' || content === null) {
        content = {
          content: '' + content
    ...
    return this.requestHandler.request('PATCH', Endpoints.CHANNEL_MESSAGE(channelID, messageID), true, content, file).then((message) => new Message(message, this));
  }
  ...
  */
   ...
   */
  getCommands(id) {
    return this.requestHandler.request('GET', Endpoints.COMMANDS(id), true);
  }
   ...
   * @returns {PromiseLike<*> | Promise<*>}
   */
  getCommandsGuild({ id, guildID }) {
    return this.requestHandler.request('GET', Endpoints.COMMAND_GUILD(id, guildID), true);
  }
  ...
  */
  ...
  /**
    @description  >> need <<
    */
  getThreadsActive(channelID) {
    if (!this.options.restMode) {
      return Promise.reject(new Error('Eris REST mode is not enabled'));
    }
    return this.requestHandler.request('GET', Endpoints.GUILD_CHANNELS_THREAD_ACTIVE(channelID), true)
      .then((channel) => Channel.from(channel, this));
  }
  ...
  /**
    @description  >> need <<
    */
  getThreadsMe(channelID) {
    if (!this.options.restMode) {
      return Promise.reject(new Error('Eris REST mode is not enabled'));
    }
    return this.requestHandler.request('GET', Endpoints.GUILD_CHANNELS_ME_THREADS_ARCHIVED_PRIVATE(channelID), true)
      .then((channel) => Channel.from(channel, this));
  }
  ...
  /**
    @description  >> need <<
    */
  getThreadsPrivate(channelID) {
    if (!this.options.restMode) {
      return Promise.reject(new Error('Eris REST mode is not enabled'));
    }
    return this.requestHandler.request('GET', Endpoints.GUILD_CHANNELS_THREAD_ARCHIVED_PRIVATE(channelID), true)
      .then((channel) => Channel.from(channel, this));
  }
  ...
  /**
      @description  >> need <<
      */
  getThreadsPublic(channelID) {
    if (!this.options.restMode) {
      return Promise.reject(new Error('Eris REST mode is not enabled'));
    }
    return this.requestHandler.request('GET', Endpoints.GUILD_CHANNELS_THREAD_ARCHIVED_PUBLIC(channelID), true)
      .then((channel) => Channel.from(channel, this));
  }
  ...
  */
  ...
  /**
     ...
     * @deprecated
     */
  async responseToAnInteraction(interaction_id, interaction_token, application_id, data, file) {
    await this.requestHandler.request('POST', Endpoints.RESPONDIG_TO_A_INTERACTION(interaction_id, interaction_token), true, { type: 5 });
    if (typeof data === 'object') {
      if (typeof data.type === 'undefined') {
        data.type = 4;
      }
    }
    return this.createFollowUpMessage(application_id, interaction_token, data, file);
  }
   ...
   * @returns {Promise<boolean>}
   */
  async sendPingInteraction(interaction_id, interaction_token, ephemeral) {
    const data = {
      type: 5
    };
    ...
    return this.requestHandler.request('POST', Endpoints.RESPONDIG_TO_A_INTERACTION(interaction_id, interaction_token), true, data).then(() => true);
  }

  /**
   * Set a time out on the guild member
   * @arg {String} guildID
   *  @arg {String} memberID
   *  @arg {String} communication_disabled_until
   *  @arg {String} reason
   *  @returns {Promise<Member}
   */

  setGuildMemberTimeout(guildID, memberID, communication_disabled_until, reason) {
    return this.requestHandler.request('PATCH', Endpoints.GUILD_MEMBER(guildID, memberID), true, { communication_disabled_until, reason }).then((member) => member);
  }
   ...
   * @returns {PromiseLike<*> | Promise<*>}
   */
  updateCommand(command, idCommand, id) {
    return this.requestHandler.request('PATCH', Endpoints.GET_COMMAND(id, idCommand), true, command).then((commandData) => new CommandBase(commandData));
  }
   ...
   * @returns {PromiseLike<*> | Promise<*>}
   */
  updateCommandGuild({ command, commandID, guildID }) {
    if (commandID !== undefined) {
      return this.requestHandler.request('PATCH', Endpoints.GET_COMMAND_GUILD(this.user.id, commandID, guildID), true, command).then((commandData) => new CommandBase(commandData));
    }
    if (command.id !== undefined) {
      return this.requestHandler.request('PATCH', Endpoints.GET_COMMAND_GUILD(this.user.id, command.id, guildID), true, command).then((commandData) => new CommandBase(commandData));
    }
    return this.requestHandler.request('PATCH', Endpoints.GET_COMMAND_GUILD(this.user.id, command, guildID), true, command).then((commandData) => new CommandBase(commandData));
  }
