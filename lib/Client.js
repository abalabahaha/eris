...
class Client extends EventEmitter {
    ...
    */
    joinVoiceChannel(channelID) {
        ...
        return this.voiceConnections.join(this.channelGuildMap[channelID] || "call", channelID);
    }
    ...
    * @arg {Number} [options.defaultNotifications] The default notifications for the guild.  0 is "All Messages", 1 is "Only @mentions".
    ...
    */
    getGuildMember(guildID, memberID) {
        ...
        return this.requestHandler.request("GET", Endpoints.GUILD_MEMBER(guildID, memberID)).then((member) => new Member(member, guild));
    }
