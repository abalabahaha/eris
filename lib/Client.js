...
class Client extends EventEmitter {
  ...
  createFollowUpMessage(application_id, interaction_token, data, file, interaction) {
    if (typeof file === 'undefined') {
      return this.requestHandler.request('POST', Endpoints.FOLLOW_UP_NEW(application_id, interaction_token), true, data, file).then((message) => new MessageInteraction(message, this, interaction));
    }
