...
class Client extends EventEmitter {
    ...
    */
    createCommand(command) {
        ...
        if(command.options && command.options.defaultPermission) {
            command.options.default_permission = command.options.defaultPermission;
            delete command.options.defaultPermission;
        }
