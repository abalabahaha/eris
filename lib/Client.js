...
class Client extends EventEmitter {
    ...
    */
    getRESTGuildMembers(guildID, limit, after) {
        ...
        return this.requestHandler.request("GET", Endpoints.GUILD_MEMBERS(guildID), true, {
            limit,
            after
        }).then((members) => members.map((member) => new Member(member, this.guilds.get(guildID))));
    }
    ...
    */
    getRESTGuildMember(guildID, memberID) {
        ...
        return this.requestHandler.request("GET", Endpoints.GUILD_MEMBER(guildID, memberID), true).then((member) => new Member(member, this.guilds.get(guildID)));
    }
