        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "CHANNEL_CREATE": {
                if(packet.d.type === 1) {
                    ...
                    console.log("Unhandled CHANNEL_CREATE type: " + packet.d.type);
            ...
            case "CHANNEL_DELETE": {
                if(packet.d.type === 1) {
                    ...
                    console.log("Unhandled CHANNEL_DELETE type: " + packet.d.type);
                    console.log(JSON.stringify(packet, null, 2));
                }
                break;
            }
            ...
            case "READY": {
                ...
                packet.d.private_channels.forEach((channel) => {
                    if(channel.type === 1) {
                        ...
                        console.log("Unhandled READY private_channel type: " + channel.type);
