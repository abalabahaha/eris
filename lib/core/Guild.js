...
* @prop {Number} defaultNotification The Default Notification Stage in guild settings (0, and 1 are respectively, "All messages", and "only @mentions")
* @prop {Boolean} large The status whether a guild is large
* @prop {Number} mfa The 2FA stage in server (0, and 1 are respectively, disabled, and enabled)
...
class Guild {
    ...
    update(data) {
        ...
        this.defaultNotification = data.default_message_notifications !== undefined ? data.default_message_notifications : this.defaultNotification;
        this.large = data.large !== undefined ? data.large : this.large
        this.mfa = data.mfa_level !== undefined ? data.mfa_level : this.mfa
    }
