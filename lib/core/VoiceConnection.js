...
class VoiceConnection extends EventEmitter {
            ...
            this.ws.on("open", () => {
                ...
                */
                ...
                this.sendWS(OPCodes.IDENTIFY, {
                    server_id: this.id === "Group" ? this.channelID : this.id,
    ...
    * @arg {String} channelID The ID of the channel to switch to
    */
    ...
    */
    updateVoiceState(selfMute, selfDeaf) {
        this.shard.sendWS(Constants.GatewayOPCodes.VOICE_STATE_UPDATE, {
            guild_id: this.id === "Group" ? null : this.id,
