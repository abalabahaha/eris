...
class VoiceConnection extends EventEmitter {
    ...
    */
    playStream(stream, options) {
        ...
        pipe.once('unpipe', killStream);
        pipe.once('end', killStream);

        stream.once("error", killEncoder);

        encoder.once("close", killEncoder);
        ...
        if(options.inlineVolume) {
            ...
            this.volumeTransformer.once("error", killEncoder);
            this.volumeTransformer.once("unattach", killEncoder);
        }
