...
class Bucket {
    ...
    * @arg {Number} reserved How many tokens to reserve for priority operations
    * @arg {Object} [latencyRef] An object
    * @arg {Number} latencyRef.latency Interval between consuming tokens
    */
    constructor(tokenLimit, interval, reserved = 0, latencyRef = {latency: 0}) {
    ...
    */
    ...
    check() {
        ...
        const unreservedTokensAvailable = this.tokens < (this.tokenLimit - this.reserved);
