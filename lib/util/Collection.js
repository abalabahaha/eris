...
class Collection extends Map {
    ...
    */
     ...
     * @param {any} val The initial value passed to the function
     */
    reduce(func, val) {
        return Array.from(this.values()).reduce(func, val);
    }

    /**
     * Returns an array with the elements of the collection sorted
     * @param {function} func A function that takes two objects and returns -1, 0, or 1
     */
    sort(func) {
        return Array.from(this.values()).sort(func);
    }
