...
const OpusScript = require("../../deps/opusscript/Opus.js");
...
class VoiceConnection extends EventEmitter {
    constructor(guildID, shard) {
        ...
        try {
            ...
            this.opus = new OpusScript(this.samplingRate, this.channels, OpusScript.Application.AUDIO, this.frameDuration, this.bitrate);
        }
