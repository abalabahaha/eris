...
* @prop {Number} playTime Position of playback of current resource in milliseconds (TODO OUTDATED)
...
class VoiceConnection extends EventEmitter {
    constructor(id, options) {
        ...
        if(this.shard.client && this.shard.client.opus) {
            this.opus = this.shard.client.opus;
        } else if(!options.opusOnly || !options.shared) {
            try {
                ...
                try {
                    ...
                    /**
                    * Fired when the voice connection encounters an error. This event should be handled by library users
                    * @event VoiceConnection#error
                    * @prop {Error} err The error object
                    */
                    this.emit("error", new Error("No opus encoder found, playing non-opus audio will not work."));
                }
            }
            if(this.shard.client) {
    ...
    connect(data) {
        ...
        */
        ...
        }, this.shard.client ? this.shard.client.options.connectionTimeout : 10000);
    }
