...
class VoiceConnection extends EventEmitter {
    constructor(guildID, userID, sessionID, shard) {
        ...
        this.piper = new Piper(this.pickCommand(), this.opus, this.pcmSize, this.frameSize, this.frameDuration);
    }
    ...
    */
    ...
    _play(source, options) {
        ...
        var voiceDataTimeout = options.voiceDataTimeout !== undefined ? options.voiceDataTimeout : this.shard ? this.shard.client.options.voiceDataTimeout : 2000;
        var buffer;
        var pausedTime = 0;
        ...
        var send = () => {
            ...
            } else if(voiceDataTimeout === -1 || waitingForData < voiceDataTimeout / this.frameDuration) { // wait for data
                if(++waitingForData <= 5) {
