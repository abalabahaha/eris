...
class FFmpegDuplex extends DuplexStream {
    ...
    spawn(args, options = {}) {
        ...
        // In some rare and consistent cases, streams will cut out competely and stopPlaying is triggered.
        // It is founds that setting highWaterMark to an insanely high number will fix this.
