...
class Channel {
    ...
    */
    sendTyping() {
        return (this.client || this.guild.shard.client).sendChannelTyping.call((this.client || this.guild.shard.client), this.id);
    }
    ...
    */
    getMessage(messageID) {
        return (this.client || this.guild.shard.client).getMessage.call((this.client || this.guild.shard.client), this.id, messageID);
    }
    ...
    */
    getMessages(limit, before, after, around) {
        return (this.client || this.guild.shard.client).getMessages.call((this.client || this.guild.shard.client), this.id, limit, before, after, around);
    }
    ...
    */
    getPins() {
        return (this.client || this.guild.shard.client).getPins.call((this.client || this.guild.shard.client), this.id);
    }
    ...
    */
    createMessage(content, file) {
        return (this.client || this.guild.shard.client).createMessage.call((this.client || this.guild.shard.client), this.id, content, file);
    }
    ...
    */
    editMessage(messageID) {
        return (this.client || this.guild.shard.client).editMessage.call((this.client || this.guild.shard.client), this.id, messageID);
    }
    ...
    */
    pinMessage(messageID) {
        return (this.client || this.guild.shard.client).pinMessage.call((this.client || this.guild.shard.client), this.id, messageID);
    }
    ...
    */
    unpinMessage(messageID) {
        return (this.client || this.guild.shard.client).unpinMessage.call((this.client || this.guild.shard.client), this.id, messageID);
    }
    ...
    */
    deleteMessage(messageID) {
        return (this.client || this.guild.shard.client).deleteMessage.call((this.client || this.guild.shard.client), this.id, messageID);
    }
    ...
    */
    deleteMessages(messageIDs) {
        return (this.client || this.guild.shard.client).deleteMessages.call((this.client || this.guild.shard.client), this.id, messageIDs);
    }
    ...
    */
    purge(limit, filter, before, after) {
        return (this.client || this.guild.shard.client).purgeChannel.call((this.client || this.guild.shard.client), this.id, limit, filter, before, after);
    }
}
