...
class Channel extends Base {
    ...
    * @returns {Promise<Object>} Resolves with an array of reaction objects
    */
    getMessageReaction(messageID, reaction) {
        return (this._client || this.guild.shard.client).getMessageReaction.call((this._client || this.guild.shard.client), this.id, messageID, reaction);
    }
