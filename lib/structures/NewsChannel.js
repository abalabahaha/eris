...
class NewsChannel extends TextChannel {
    ...
    /**
     * Follow a NewsChannel
     * @param {String} targetChannelID The ID of the target channel
     * @returns {Object} An object containing the NewsChannel ID and the webhook ID in the target channel
     */
    follow(targetChannelID) {
        return this.client.followChannel.call(this.client, this.id, targetChannelID);
    }
}
