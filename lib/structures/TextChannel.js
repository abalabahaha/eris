...
class TextChannel extends GuildChannel {
    ...
    * @arg {String} [content.messageReference] A message ID of a message in this channel of which the message should be replied to. The reference message cannot be a system message.
