...
class TextChannel extends GuildChannel {
    ...
    * @returns {Promise}
    */
    removeMessageReactionsForEMoji(messageID, reaction) {
        return (this._client || this.guild.shard.client).removeMessageReactionsForEmoji.call((this._client || this.guild.shard.client), this.id, messageID, reaction);
    }
