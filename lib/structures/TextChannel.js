...
class TextChannel extends GuildChannel {
    ...
    */
    createMessage(content, files) {
        return this.client.createMessage.call(this.client, this.id, content, files);
    }
    ...
    * @returns {Promise<Message>}
    */
    editMessage(messageID, content, files) {
        return this.client.editMessage.call(this.client, this.id, messageID, content, files);
    }
