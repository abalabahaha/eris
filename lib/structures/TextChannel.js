...
class TextChannel extends GuildChannel {
    ...
    */
    createMessage(content, attachments) {
        return this.client.createMessage.call(this.client, this.id, content, attachments);
    }
    ...
    * @returns {Promise<Message>}
    */
    editMessage(messageID, content, attachments) {
        return this.client.editMessage.call(this.client, this.id, messageID, content, attachments);
    }
