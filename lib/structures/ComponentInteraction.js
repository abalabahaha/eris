...
const {InteractionResponseTypes, ApplicationCommandContextType} = require("../Constants");
 ...
 * @prop {Number} context Where the component interaction is selected from. [more info](https://discord.com/developers/docs/interactions/receiving-and-responding#interaction-object-interaction-context-types)
    ...
    constructor(data, client) {
        ...
        if(data.member !== undefined) {
            if(this.channel.guild) {
                ...
                let guild = this._client.guilds.get(data.guild_id);
                if(!guild && data.context === ApplicationCommandContextType.GUILD) {
                    guild = new Guild(data.guild, this._client);
                    data.member.id = data.member.user.id;
                }
