...
class ComponentInteraction extends Interaction {
    constructor(info, client) {
        ...
        this.data.custom_id = info.data.custom_id;
        this.data.component_type = info.data.component_type;
        //this.data.customId = info.data.customID;
        //this.data.componentType = info.data.componentType;
        if(info.data.values !== null) {
            this.data.values = info.data.values;
        }
