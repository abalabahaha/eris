...
class Invite extends Base {
    constructor(data, client) {
        ...
        if(data.guild) {
            ...
            } else if(Object.keys(data.guild).length !== 1) {
        ...
        this._expiresAt = data.expires_at !== undefined ? data.expires_at : null;
        ...
        if(data.stage_instance !== undefined) {
            ...
            this.stageInstance = {
                members: data.stage_instance.members.map((m) => this.guild instanceof Guild ? this.guild.members.update(m, this.guild) : new Member(m, undefined, this._client)),
    ...
    get createdAt() {
        return Date.parse(this._createdAt) || null;
    }

    get expiresAt() {
        return Date.parse(this._expiresAt) || null;
    }
