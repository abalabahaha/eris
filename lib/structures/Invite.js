...
* @prop {String} id The id is also the invite code.
...
class Invite extends Base {
    constructor(data, client) {
        ...
        this.guild = data.guild ? client.guilds.get(data.guild.id) : undefined;
        this.inviter = data.inviter ? client.users.add(data.inviter, client) : undefined;
    }
