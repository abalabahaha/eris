...
* @prop {StageInstance?} stageInstance  [DEPRECATED] The active public stage instance data for the stage channel this invite is for
...
class Invite extends Base {
    constructor(data, client) {
        ...
        if(data.target_user !== undefined) {
            this.targetUser = client.users.update(data.target_user, this._client);
        }
