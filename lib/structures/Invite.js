...
* @arg {String} [options.targetApplicationID] Target application id
* @arg {String} [options.targetType] Type of target application
...
class Invite extends Base {
    constructor(data, client) {
        ...
        this.targetApplicationID = data.target_application_id !== undefined ? data.target_application_id : null;
