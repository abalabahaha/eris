...
class GuildScheduledEvent extends Base {
    ...
    */
    edit(event) {
        return this._client.editGuildScheduledEvent.call(this._client, this.guildID, this.id, event);
    }
    ...
    */
    listUsers() {
        return this._client.listGuildScheduledEventUsers.call(this._client, this.guildID, this.id);
    }
