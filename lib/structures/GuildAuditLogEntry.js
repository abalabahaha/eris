...
* If the action targets a guild, this could be a Guild object, or {id: String}
* If the action targets a guild channel, this could be a GuildChannel object, or {id: String}
* If the action targets a member, this could be a Member object, or {id: String, user: User}
* If the action targets a role, this could be a Role object, or {id: String}
...
* @prop {(Member | Object)?} member The member described by the permission overwrite (action types 13-15 (CHANNEL_OVERWRITE_CREATE/UPDATE/DELETE) only). If the member is not cached, this could be {id: String}
* @prop {(Role | Object)?} role The role described by the permission overwrite (action types 13-15 (CHANNEL_OVERWRITE_CREATE/UPDATE/DELETE) only). If the role is not cached, this could be {id: String, name: String}
*/
