...
* For action types 26/27 (MEMBER_MOVE/DISCONNECT), this is the number of members that were moved/disconnected from the voice channel
* For action types 72/73 (MESSAGE(\_BULK)\_DELETE), this is the number of messages that were deleted
...
* @prop {Message?} message The message that was (un)pinned, action types 74/75 (MESSAGE_PIN/UNPIN) only
