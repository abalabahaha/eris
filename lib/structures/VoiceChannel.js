...
class VoiceChannel extends GuildTextableChannel {
   ...
   */
  join(options) {
    return this._client.joinVoiceChannel.call(this._client, this.guild.id, this.id, options);
  }
   ...
   */
  leave() {
    return this._client.leaveVoiceChannel.call(this._client, this.guild.id, this.id);
  }
