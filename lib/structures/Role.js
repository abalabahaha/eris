...
class Role {
    ...
    */
    edit(options) {
        return this.guild.shard.client.editRole.apply(this.guild.shard.client, this.guild.id, this.id, options);
    }
    ...
    */
    editPosition(position) {
        return this.guild.shard.client.editRolePosition.apply(this.guild.shard.client, this.guild.id, this.id, position);
    }
    ...
    */
    delete() {
        return this.guild.shard.client.deleteRole.apply(this.guild.shard.client, this.guild.id, this.id);
    }
}
