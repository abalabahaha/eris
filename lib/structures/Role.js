...
class Role {
    ...
    */
    edit() {
        return this.guild.shard.client.editRole.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
    ...
    */
    editPosition() {
        return this.guild.shard.client.editRolePosition.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
    ...
    */
    delete() {
        return this.guild.shard.client.deleteRole.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
}
