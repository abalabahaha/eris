...
/**
* Represents a slash command interaction. See Interaction for more properties.
* @extends Interaction
...
* @prop {String} data.id The ID of the Slash Command
* @prop {String} data.name The command name
* @prop {Array<Object>?} data.options The run Slash Command options
