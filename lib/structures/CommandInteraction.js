...
* @prop {Object?} data.resolved converted users + roles + channels + messages + attachments
...
* @prop {Collection<Messages>?} data.resolved.messages converted messages
* @prop {Collection<Attachment>?} data.resolved.attachments converted attachments
    ...
    constructor(info, client) {
        ...
        if(info.data.resolved !== undefined) {
            ...
            if(info.data.resolved.attachments !== undefined) {
                ...
                Object.entries(info.data.resolved.attachments).forEach(([id, attachment]) => {
