...
class PrivateChannel extends Channel {
    ...
    */
    getMessageReaction(messageID, reaction, limit, after) {
        return (this._client || this.guild.shard.client).getMessageReaction.call((this._client || this.guild.shard.client), this.id, messageID, reaction, limit, after);
    }
