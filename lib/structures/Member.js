...
class Member extends Base {
  constructor(data, guild, client) {
    ...
    if (!data.avatar) {
      ...
      this.guildAvatar = this.guild.shard.client._formatImage(Endpoints.GUILD_MEMBER_AVATAR(this.guild.id, this.user.id, data.avatar));
    }
  ...
  setTimeout({ communication_disabled_until, reason }) {
    return this.guild.shard.client.setGuildMemberTimeout.call(this.guild.shard.client, this.guild.id, this.id, communication_disabled_until, reason);
  }
