...
class Member {
    ...
    */
    edit(options) {
        return this.guild.shard.client.editGuildMember.apply(this.guild.shard.client, this.guild.id, this.id, options);
    }
    ...
    */
    delete() {
        return this.guild.shard.client.deleteGuildMember.apply(this.guild.shard.client, this.guild.id, this.id);
    }
    ...
    */
    ban(deleteMessageDays) {
        return this.guild.shard.client.banGuildMember.apply(this.guild.shard.client, this.guild.id, this.id, deleteMessageDays);
    }
    ...
    */
    unban() {
        return this.guild.shard.client.unbanGuildMember.apply(this.guild.shard.client, this.guild.id, this.id);
    }
}
