...
* @prop {String} guildAvatar The URL of the user's avatar which can be either a JPG or GIF
...
class Member extends Base {
  constructor(data, guild, client) {
    ...
    if (data.avatar === undefined) {
      this.guildAvatar = null;
    } else {
      if (data.avatar?.startsWith("a_")) {
        this.guildAvatar = `https://cdn.discordapp.com/guilds/${this.guild.id}/users/${this.user.id}/avatars/${data.avatar}.gif?size=2048`;
      } else {
        this.guildAvatar = `https://cdn.discordapp.com/guilds/${this.guild.id}/users/${this.user.id}/avatars/${data.avatar}.png?size=2048`;
      }
  ...
  update(data) {
    ...
    if (data.avatar === undefined) {
      ...
      if (data.avatar?.startsWith("a_")) {
        this.guildAvatar = `https://cdn.discordapp.com/guilds/${this.guild.id}/users/${this.user.id}/avatars/${data.avatar}.gif`;
      } else {
        this.guildAvatar = `https://cdn.discordapp.com/guilds/${this.guild.id}/users/${this.user.id}/avatars/${data.avatar}.png`;
      }
