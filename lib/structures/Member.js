...
* @prop {String} serverAvatar The URL of the user's avatar which can be either a JPG or GIF
...
class Member extends Base {
    constructor(data, guild, client) {
        ...
        if(data.avatar === undefined) {
            this.serverAvatar = null;
        } else {
            if (data.avatar.startsWith('a_') === true) {
                this.serverAvatar = `https://cdn.discordapp.com/guilds/${this.guild.id}/users/${this.user.id}/avatars/${data.avatar}.gif`
            } else {
                this.serverAvatar = `https://cdn.discordapp.com/guilds/${this.guild.id}/users/${this.user.id}/avatars/${data.avatar}`  
            }
