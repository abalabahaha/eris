...
class Member {
    ...
    */
    edit() {
        return this.guild.shard.client.editGuildMember.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
    ...
    */
    delete() {
        return this.guild.shard.client.deleteGuildMember.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
    ...
    */
    ban() {
        return this.guild.shard.client.banGuildMember.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
    ...
    */
    unban() {
        return this.guild.shard.client.unbanGuildMember.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
}
