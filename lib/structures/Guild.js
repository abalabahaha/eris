...
* @prop {String?} banner The hash of the guild banner image, or null if no splash (VIP only)
...
* @prop {String?} vanityURL The vanity URL of the guild
* @prop {String} preferredLocale Preferred guild language
* @prop {String} description The description for the guild
...
class Guild extends Base {
    ...
    update(data) {
        ...
        this.premiumTier = data.premium_tier !== undefined ? data.premium_tier : this.premium_tier;
        ...
        this.vanityURL = data.vanity_url_code !== undefined ? data.vanity_url_code : this.vanity_url_code;
        ...
        this.maxMembers = data.max_members !== undefined ? data.max_members : this.max_members;
    }
    ...
    */
    ...
    toJSON() {
        ...
        for(const prop of ["afkChannelID", "afkTimeout", "channels", "defaultNotifications", "emojis", "explicitContentFilter", "features", "icon", "joinedAt", "large", "maxPresences", "memberCount", "members", "mfaLevel", "name", "ownerID", "region", "roles", "splash", "banner", "unavailable", "verificationLevel", "premiumTier", "premiumSuscriptionCount", "vanityURL", "preferredLocale", "description", "maxMembers"]) {
