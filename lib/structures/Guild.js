...
class Guild extends Base {
    constructor(data, client) {
        ...
        if (data.members) {
            for (const member of data.members) {
                ...
                if ((this._client.options.cacheMembers)) {
                    this.members.add(member, this);
                }
                else if (member.id == this._client.user.id) this.members.add(member, this);
            }
        }
        ...
        if (data.presences) {
            for (const presence of data.presences) {
                ...
                this._client.options.cacheMembers ? this.members.update(presence) : new Member(presence, this);
            }
        }
            ...
            if (!client.bot) {
                ...
                for (const voiceState of data.voice_states) {
                    ...
                    try {
                        ...
                        const member = this._client.options.cacheMembers ? this.members.update(voiceState) : new Member(voiceState, this);
    ...
    update(data) {
        ...
        if (data.emojis !== undefined) {
            this.emojis = this._client.options.cacheEmojis ? data.emojis : [];
        }
