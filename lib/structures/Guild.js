...
const { Permissions, EntitlementOwnerTypes } = require("../Constants");
...
class Guild extends Base {
  ...
  createTestEntitlement(skuID) {
    return this._client.createTestEntitlement.call(this._client, this.id, {
      skuID,
      ownerID: this.id,
  ...
  /**
   * Get a list of entitlements for this guild
  ...
  getEntitlements(options = {}) {
    return this._client.getEntitlements.call(this._client, this.id, {
      guildID: this.id,
      ...options
    })
  }
