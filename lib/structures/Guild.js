...
class Guild extends Base {
    constructor(data, client) {
        super(data.id);
        this.shard = client.ws.shards.get(client.guildShardMap[this.id]);
        ...
        if (data.emojis) {
            for (const emoji of data.emojis) this.emojis.add(emoji, this);
        }
    ...
    */
    ...
    /**
     * Gets the bot user as an member
     * @returns {?Member}
     */
    get me() {
        return this.members.get(this.shard.client.user.id) || null;
    }
