...
class Guild extends Base {
    ...
    * @arg {String} [parent] ID of the parent category for a channel
    * @returns {Promise<GuildChannel>}
    */
    createChannel(name, type, reason, parent) {
        return this.shard.client.createChannel.call(this.shard.client, this.id, name, type, reason, parent);
    }
