...
class Guild extends Base {
    ...
    */
    getCommand(commandID, withLocalizations) {
        return this._client.getGuildCommand.call(this._client, this.id, commandID, withLocalizations);
    }
    ...
    */
    getCommands(withLocalizations) {
        return this._client.getGuildCommands.call(this._client, this.id, withLocalizations);
    }
