...
* @prop {Number} contentFilterLevel The level of the explicit content filter for messages/images in the guild. 0 disables message scanning, 1 enables scanning the messages of members without roles, 2 enables scanning for all messages.
...
class Guild extends Base {
    ...
    update(data) {
        ...
        this.contentFilterLevel = data.explicit_content_filter !== undefined ? data.explicit_content_filter : this.contentFilterLevel;
