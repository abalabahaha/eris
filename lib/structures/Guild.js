...
class Guild {
    ...
    */
    createChannel(name, type) {
        return this.shard.client.createChannel.apply(this.shard.client, this.id, name, type);
    }
    ...
    */
    createRole() {
        return this.shard.client.createRole.apply(this.shard.client, this.id);
    }
    ...
    */
    getPruneCount(days) {
        return this.shard.client.getPruneCount.apply(this.shard.client, this.id, days);
    }
    ...
    */
    pruneMembers(days) {
        return this.shard.client.pruneMembers.apply(this.shard.client, this.id, days);
    }
    ...
    */
    getVoiceRegions() {
        return this.shard.client.getVoiceRegions.apply(this.shard.client, this.id);
    }
    ...
    */
    edit(roleID) {
        return this.shard.client.editRole.apply(this.shard.client, this.id, roleID, options);
    }
    ...
    */
    deleteRole(roleID) {
        return this.shard.client.deleteRole.apply(this.shard.client, this.id, roleID);
    }
    ...
    */
    getIntegrations() {
        return this.shard.client.getGuildIntegrations.apply(this.shard.client, this.id);
    }
    ...
    */
    editIntegration(integrationID, options) {
        return this.shard.client.editGuildIntegration.apply(this.shard.client, this.id, integrationID, options);
    }
    ...
    */
    syncIntegration(integrationID) {
        return this.shard.client.syncGuildIntegration.apply(this.shard.client, this.id, integrationID);
    }
    ...
    */
    deleteIntegration(integrationID) {
        return this.shard.client.deleteGuildIntegration.apply(this.shard.client, this.id, integrationID);
    }
    ...
    */
    getInvites() {
        return this.shard.client.getGuildInvites.apply(this.shard.client, this.id);
    }
    ...
    * @returns {Promise}
    */
    editGuildMember(userID, options) {
        return this.shard.client.editGuildMember.apply(this.shard.client, this.id, userID, options);
    }
    ...
    * @returns {Promise}
    */
    deleteGuildMember(userID) {
        return this.shard.client.deleteGuildMember.apply(this.shard.client, this.id, userID);
    }
    ...
    */
    banMember(userID, deleteMessageDays) {
        return this.shard.client.banGuildMember.apply(this.shard.client, this.id, userID, deleteMessageDays);
    }
    ...
    */
    unbanMember() {
        return this.shard.client.unbanGuildMember.apply(this.shard.client, this.id, userID);
    }
    ...
    */
    edit(options) {
        return this.shard.client.editGuild.apply(this.shard.client, this.id, options);
    }
    ...
    */
    delete() {
        return this.shard.client.deleteGuild.apply(this.shard.client, this.id);
    }
    ...
    */
    leave() {
        return this.shard.client.leaveGuild.apply(this.shard.client, this.id);
    }
    ...
    */
    getBans() {
        return this.shard.client.getGuildBans.apply(this.shard.client, this.id);
    }
    ...
    */
    editNickname(nick) {
        return this.shard.client.editNickname.apply(this.shard.client, this.id, nick);
    }
}
