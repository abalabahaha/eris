...
class Guild extends Base {
  constructor(data, client) {
    ...
    if (data.soundboard_sounds) {
      // TODO Soundboard collection, but there is no `id`, only `sound_id`
    }
    this.update(data);
  }
  ...
  createSoundboardSound(options, reason) {
    return this._client.createGuildSoundboardSound.call(this._client, this.id, options, reason);
  }
