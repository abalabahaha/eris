...
class Guild extends Base {
    constructor(data, client) {
        ...
        this.events = new Collection(GuildEvent);
    ...
    */
    ...
    /**
    * Create a scheduled guild event in this guild
    ...
    */
    createEvent(event) {
        return this._client.createGuildEvent.call(this._client, this.id, event);
    }
    ...
    */
    getRESTEvent(eventID) {
        return this._client.getRESTGuildEvent.call(this._client, this.id, eventID);
    }
    /**
    ...
    */
    ...
    /**
    * List all scheduled events for this guild
    * @arg {Boolean} withUserCount Whether to include number of users subscribed to each event
    * @returns {Promise<Array<GuildEvent>>}
    */
    listEvents(withUserCount) {
        return this._client.listGuildEvents.call(this._client, this.id, withUserCount);
    }

    /**
    * List all users that subscribed to the given event
    * @arg {String} eventID The event id
    * @returns {}
    */
    listEventUsers(eventID) {
        return this._client.listGuildEventUsers.call(this._client, this.id, eventID);
    }
