...
class Guild extends Base {
    ...
    */
    ...
    get iconURL() {
        return this.icon ? `${CDN_URL}/icons/${this.id}/${this.icon}.${this._client.options.defaultImageFormat}${this._client.options.defaultImageSize == 128 ? "" : `?size=${this._client.options.defaultImageSize}`}` : null;
    }
    ...
    */
    dynamicIconURL(format, size) {
        ...
        return this.icon ? `${CDN_URL}/icons/${this.id}/${this.icon}.${format}${size == 128 ? "" : `?size=${size}`}` : null;
    }
