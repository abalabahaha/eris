...
class Guild extends Base {
    ...
    */
    ...
    /**
    * Create a guild scheduled event in this guild
    ...
    * @returns {Promise}
    */
    createScheduledEvent(event) {
        return this._client.createGuildScheduledEvent.call(this._client, this.id, event);
    }
    ...
    */
    getRESTEvent(eventID) {
        return this._client.getRESTGuildScheduledEvent.call(this._client, this.id, eventID);
    }
    ...
    */
    listEvents(withUserCount) {
        return this._client.listGuildScheduledEvents.call(this._client, this.id, withUserCount);
    }
    ...
    */
    listEventUsers(eventID) {
        return this._client.listGuildScheduledEventUsers.call(this._client, this.id, eventID);
    }
