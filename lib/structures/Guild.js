...
class Guild extends Base {
    ...
    * @returns {Promise} Resolves with a promise object
    */
    deleteGuildCommand(commandID) {
        return this._client.getGuildCommands.call(this.application.id, this.id, commandID);
    }
    ...
    * @arg {String} commandID The command id
    * @returns {Promise} Resolves with a commands object
    */
