...
class Guild extends Base {
     ...
     * @arg {String|String[]} [options.query] The query used for looking up the members. If an array is passed, members will be looked up by their IDs instead. When using intents, `GUILD_MEMBERS` is required to fetch all members.
