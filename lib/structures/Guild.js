...
class Guild extends Base {
    ...
    update(data) {
        ...
        if(data.verificationLevel !== undefined) this.verificationLevel = data.verification_level;
        ...
        if(data.ownerID !== undefined) this.ownerID = data.owner_id;
        if(data.icon !== undefined) this.icon = data.icon;
        if(data.features !== undefined) this.features = data.features;
        if(data.emojis !== undefined) this.emojis = data.emojis;
        if(data.afkChannelID !== undefined) this.afkChannelID = data.afk_channel_id;
        if(data.afkTimeout !== undefined) this.afkTimeout = data.afk_timeout;
        if(data.defaultNotifications !== undefined) this.defaultNotifications = data.default_message_notifications;
        if(data.mfaLevel !== undefined) this.mfaLevel = data.mfa_level;
        if(data.large !== undefined) this.large = data.large;
        if(data.maxPresences !== undefined) this.maxPresences = data.max_presences;
        if(data.explicitContentFilter !== undefined) this.explicitContentFilter = data.explicit_content_filter;
        if(data.systemChannelID !== undefined) this.systemChannelID = data.system_channel_id;
        if(data.premiumTier !== undefined) this.premiumTier = data.premium_tier;
        if(data.premiumSubscriptionCount !== undefined) this.premiumSubscriptionCount = data.premium_subscription_count;
        if(data.vanityURL !== undefined) this.vanityURL = data.vanity_url_code;
        if(data.preferredLocale !== undefined) this.preferredLocale = data.preferred_locale;
        if(data.description !== undefined) this.description = data.description;
        if(data.maxMembers !== undefined) this.maxMembers = data.max_members;
    }
    ...
    */
    ...
    toJSON() {
        ...
        for(const prop of ["afkChannelID", "afkTimeout", "banner", "channels", "defaultNotifications", "description", "emojis", "explicitContentFilter", "features", "icon", "joinedAt", "large", "maxMembers", "maxPresences", "memberCount", "members", "mfaLevel", "name", "ownerID", "preferredLocale", "premiumSubscriptionCount", "premiumTier", "region", "roles", "splash", "unavailable", "vanityURL", "verificationLevel"]) {
