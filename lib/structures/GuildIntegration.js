...
class GuildIntegration {
    ...
    */
    edit(options) {
        return this.guild.shard.client.editGuildIntegration.apply(this.guild.shard.client, this.guild.id, this.id, options);
    }
    ...
    */
    delete() {
        return this.guild.shard.client.deleteGuildIntegration.apply(this.guild.shard.client, this.guild.id, this.id);
    }
    ...
    */
    sync() {
        return this.guild.shard.client.syncGuildIntegration.apply(this.guild.shard.client, this.guild.id, this.id);
    }
}
