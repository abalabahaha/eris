...
class GuildIntegration {
    ...
    */
    edit() {
        return this.guild.shard.client.editGuildIntegration.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
    ...
    */
    delete() {
        return this.guild.shard.client.deleteGuildIntegration.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
    ...
    */
    sync() {
        return this.guild.shard.client.syncGuildIntegration.apply(this.guild.shard.client, [this.guild.id, this.id].concat(arguments));
    }
}
