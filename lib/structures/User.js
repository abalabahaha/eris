...
class User extends Base {
    ...
    */
    dynamicAvatarURL(format, size) {
        if (!ImageFormats.includes(format.toLowerCase())) format = this._client.defaultImageFormat;
        if (!ImageSizes.includes(size.toLowerCase())) size = this._client.defaultImageSize;
