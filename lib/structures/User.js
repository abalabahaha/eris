...
class User {
    ...
    */
    getDMChannel() {
        return this._client.getDMChannel.apply(this._client, this.id);
    }
    ...
    */
    addRelationship(block) {
        return this._client.addRelationship.apply(this._client, this.id, block);
    }
    ...
    */
    removeRelationship() {
        return this._client.removeRelationship.apply(this._client, this.id);
    }
}
