...
class User {
    ...
    */
    getDMChannel() {
        return this._client.getDMChannel.apply(this._client, [this.id].concat(arguments));
    }
    ...
    */
    addRelationship() {
        return this._client.addRelationship.apply(this._client, [this.id].concat(arguments));
    }
    ...
    */
    removeRelationship() {
        return this._client.removeRelationship.apply(this._client, [this.id].concat(arguments));
    }
}
