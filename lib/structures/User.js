...
class User extends Base {
    ...
    */
    dynamicAvatarURL(format, size) {
        if (format === undefined || !ImageFormats.includes(format.toLowerCase())) format = this._client.defaultImageFormat;
        if (size === undefined || !ImageSizes.includes(size.toLowerCase())) size = this._client.defaultImageSize;
