...
class UnknownInteraction extends Interaction {
    ...
    */
    async createFollowup(content, files) {
        ...
        return this._client.executeWebhook.call(this._client, this.applicationID, this.token, Object.assign({wait: true}, content, files));
    }
    ...
    async createMessage(content, files) {
        ...
        if(content !== undefined) {
            if(typeof content !== "object" || content === null) {
                ...
                content.content = "" + content.content;
            } else if(content.content === undefined && !content.embeds && !files) {
    ...
    */
    async deleteMessage(messageID) {
        if(this.acknowledged === false) {
            throw new Error("deleteMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, defer, deferUpdate, editParent, pong, or result first.");
        }
    ...
    */
    async deleteOriginalMessage() {
        if(this.acknowledged === false) {
            throw new Error("deleteOriginalMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, defer, deferUpdate, editParent, pong, or result first.");
        }
    ...
    */
    async editMessage(messageID, content, files) {
        ...
        return this._client.editWebhookMessage.call(this._client, this.applicationID, this.token, messageID, content, files);
    }
    ...
    * @returns {Promise<Message>}
    */
    async editOriginalMessage(content, files) {
        if(this.acknowledged === false) {
        ...
        return this._client.editWebhookMessage.call(this._client, this.applicationID, this.token, "@original", content, files);
    }
    ...
    * @returns {Promise}
    */
    async editParent(content, files) {
        if(this.acknowledged === true) {
    ...
    */
    async getOriginalMessage() {
        if(this.acknowledged === false) {
            throw new Error("getOriginalMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, defer, deferUpdate, editParent, pong, or result first.");
        }
