...
/**
 * Represents a DM channel. See Channel for more properties and methods.
 * @extends Channel
 * @prop {String?} lastMessageID The ID of the last message in this channel // REVIEW - Can be null or undefined
 * @prop {Number?} lastPinTimestamp The timestamp of the last pinned message // REVIEW - Can be undefined when no message pinned
...
class DMChannel extends Channel {
    /**
     * @arg {Record<string, string>} data
     * @arg {import("../Client")} client
     */
