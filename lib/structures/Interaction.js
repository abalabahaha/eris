...
class Interaction extends Base {
    ...
    */
    async acknowledge() {
        return this._client.createInteractionResponse.call(this.id, this.token, {
    ...
    */
    async createFollowup(content) {
        ...
        return this._client.executeWebhook.call(this.applicationId, this.token, content);
    }
    ...
    */
    async delete(messageId) {
        return this._client.deleteWebhookMessage.call(this.applicationId, this.token, messageId);
    }
    ...
    */
    async edit(messageId, content) {
        ...
        return this._client.editWebhookMessage.call(this.applicationId, this.token, messageId, content, true);
    }
