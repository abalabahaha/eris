...
class Interaction extends Base {
    ...
    */
    ...
    /**
    * Edit a message
    * @arg {String} messageId the id of the message to edit, or "@original" for the original response, "@original" will error with ephemeral messages. For component interactions, "@original" edits the parent message
    ...
    */
    ...
    /**
    * Get the Original Interaction response. For message comonents, the message the interaction came from.
    * Note: Will error with ephemeral messages.
    * @returns {Promise<Message>}
    */
    async getOriginal() {
