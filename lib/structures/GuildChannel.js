...
class GuildChannel extends Channel {
    ...
    * @arg {Number?} [options.parentID] The ID of the parent channel category for this channel (text/voice channels only) or the channel ID where the thread originated from (thread channels only)
