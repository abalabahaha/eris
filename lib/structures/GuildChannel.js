...
* @prop {String} type The type of the channel, either 0 or 2
...
class GuildChannel extends Channel {
    constructor(data, guild, limit) {
        super(data);
        this.guild = guild;
        if(this.type === 2) {
            this.voiceMembers = new Collection(Member, limit != null ? limit : guild && guild.shard.client.options._collectionLimit);
        } else {
            if(limit == null && guild) {
                if((limit = guild.shard.client.options._collectionLimit) == null) {
                    limit = guild.shard.client.options._collectionLimit;
                }
            }
            this.messages = new Collection(Message, limit);
