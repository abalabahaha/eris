...
class GuildChannel extends Channel {
    ...
    */
    permissionsOf(memberID) {
        ...
        return this.permissionsCalculator(memberID, member.roles);
    }

    permissionsCalculator(memberID, roleIDs = []) {
        let permission = this.guild.permissionsCalculator(memberID, roleIDs).allow;
