...
/**
 * Represents a guild channel. You also probably want to look at CategoryChannel, NewsChannel, TextChannel, ThreadChannel, and VoiceChannel. See Channel for extra properties.
 * @extends Channel
...
class GuildChannel extends Channel {
     ...
     * @arg {Array<PermissionOverwrite | Object>?} [options.permissionOverwrites] [All] An object containing [permission overwrite](https://discord.dev/resources/channel#overwrite-object) objects
     ...
     * @arg {String} [reason] The reason to be displayed in audit logs
     * @returns {Promise<CategoryChannel | GroupChannel | NewsChannel | NewsThreadChannel | PrivateThreadChannel | PublicThreadChannel | TextChannel | VoiceChannel>}
     */
    edit(options, reason) {
