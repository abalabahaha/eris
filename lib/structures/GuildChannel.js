...
class GuildChannel extends Channel {
    ...
    */
    edit(options) {
        return this.guild.shard.client.editChannel.apply(this.guild.shard.client, this.id, options);
    }
    ...
    */
    editPosition(position) {
        return this.guild.shard.client.editChannelPosition.apply(this.guild.shard.client, this.id, position);
    }
    ...
    */
    delete() {
        return this.guild.shard.client.deleteChannel.apply(this.guild.shard.client, this.id);
    }
    ...
    */
    editPermission(overwriteID, allow, deny, type) {
        return this.guild.shard.client.editChannelPermission.apply(this.guild.shard.client, this.id, overwriteID, allow, deny, type);
    }
    ...
    */
    deletePermission(overwriteID) {
        return this.guild.shard.client.deleteChannelPermission.apply(this.guild.shard.client, this.id, overwriteID);
    }
    ...
    */
    createInvite(options) {
        return this.guild.shard.client.createInvite.apply(this.guild.shard.client, this.id, options);
    }
}
