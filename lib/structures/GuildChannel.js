...
class GuildChannel extends Channel {
    ...
    */
    edit() {
        return this.guild.shard.client.editChannel.apply(this.guild.shard.client, [this.id].concat(arguments));
    }
    ...
    */
    editPosition() {
        return this.guild.shard.client.editChannelPosition.apply(this.guild.shard.client, [this.id].concat(arguments));
    }
    ...
    */
    delete() {
        return this.guild.shard.client.deleteChannel.apply(this.guild.shard.client, [this.id].concat(arguments));
    }
    ...
    */
    editPermission() {
        return this.guild.shard.client.editChannelPermission.apply(this.guild.shard.client, [this.id].concat(arguments));
    }
    ...
    */
    deletePermission() {
        return this.guild.shard.client.deleteChannelPermission.apply(this.guild.shard.client, [this.id].concat(arguments));
    }
    ...
    */
    getInvites() {
        return this.guild.shard.client.getChannelInvites.apply(this.guild.shard.client, [this.id].concat(arguments));
    }
    ...
    */
    createInvite() {
        return this.guild.shard.client.createInvite.apply(this.guild.shard.client, [this.id].concat(arguments));
    }
}
