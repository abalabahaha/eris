...
class GroupChannel extends PrivateChannel { // (╯°□°）╯︵ ┻━┻
    ...
    */
    edit(options) {
        return this.client.editChannel.apply(this.client, this.id, options);
    }
    ...
    */
    addRecipient(userID) {
        return this.client.addGroupRecipient.apply(this.client, this.id, userID);
    }
    ...
    */
    removeRecipient(userID) {
        return this.client.removeGroupRecipient.apply(this.client, this.id, userID);
    }
}
