...
class GroupChannel extends PrivateChannel { // (╯°□°）╯︵ ┻━┻
    ...
    * @returns {Promise<GroupChannel>} Returns the same channel updated
    */
    edit(options) {
        return this
            ._client
            .requestHandler
            .request('PATCH', require('../rest/Endpoints').CHANNEL(this.id), true, {
                name: options.name,
                icon: options.icon,
    ...
    */
    addRecipient(userID) {
        return this
            ._client
            .requestHandler
            .request('PUT', require('../rest/Endpoints').CHANNEL_RECIPIENT(this.id, userID), true);
    }
    ...
    */
    removeRecipient(userID) {
        return this
            ._client
            .requestHandler
            .request('DELETE', require('../rest/Endpoints').CHANNEL_RECIPIENT(this.id, userID), true);
    }
