...
class GroupChannel extends PrivateChannel { // (╯°□°）╯︵ ┻━┻
    ...
    */
    ...
    get iconURL() {
        return this.icon ? this._client._formatImage(Endpoints.GROUP_ICON(this.id, this.icon)) : null;
    }
    ...
    */
    dynamicIconURL(format, size) {
        return this.icon ? this._client._formatImage(Endpoints.GROUP_ICON(this.id, this.icon), format, size) : null;
    }
