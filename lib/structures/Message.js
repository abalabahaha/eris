...
* @prop {Guild} guild The guild that owns the message
...
class Message extends Base {
  ...
  /**
     ...
     */
  createThread(data) {
    return this._client.createMessageThread.call(this._client, this.channel.id, this.id, data);
  }
  /**
     * Crosspost (publish) a message to subscribed channels (NewsChannel only)
     * @returns {Promise<Message>}
  ...
  /**
    ...
    */
  edit(content, file) {
    return this._client.editMessage.call(this._client, this.channel.id, this.id, content, file);
  }
