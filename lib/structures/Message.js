...
class Message {
    ...
    */
    edit(content, disableEveryone) {
        return this._client.editMessage.apply(this._client, this.channel.id, this.id, content, disableEveryone);
    }
    ...
    */
    pin() {
        return this._client.pinMessage.apply(this._client, this.channel.id, this.id);
    }
    ...
    */
    unpin() {
        return this._client.unpinMessage.apply(this._client, this.channel.id, this.id);
    }
    ...
    */
    delete() {
        return this._client.deleteMessage.apply(this._client, this.channel.id, this.id);
    }
}
