...
const CollectorButton = require("./ButtonCollector")
/**
...
* @prop {CollectorButton} collector Collector to interactions response.
...
class Message extends Base {
   ...
   */
    interactionCollector(options = {}){
        return new CollectorButton(this._client, {
          ...options,
          message: this
        })
      }
