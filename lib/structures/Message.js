...
class Message extends Base {
    constructor(data, client) {
        ...
        if(this.type === 0 || this.type === undefined);
            ...
            data.content = `${this.author.mention} just boosted the server! ${this.channel.guild ? this.channel.guild.name : data.guild_id} has achieved **Level 1!**`;
        } else if(this.type === 10) {
            data.content = `${this.author.mention} just boosted the server! ${this.channel.guild ? this.channel.guild.name : data.guild_id} has achieved **Level 2!**`;
        } else if(this.type === 11) {
            data.content = `${this.author.mention} just boosted the server! ${this.channel.guild ? this.channel.guild.name : data.guild_id} has achieved **Level 3!**`;
        } else {
