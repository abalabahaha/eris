 ...
 * @prop {Object?} messageReference An object containing the reference to the original message if it is a crossposted message, forwarded message or reply
 ...
 * @prop {Array<Object>?} messageSnapshots The message associated with the messageReference. This is a minimal subset of fields in a message.
 * @prop {String?} messageSnapshots.guildID ID of the origin message's guild
 * @prop {Message} messageSnapshots.message Subset of message fields. The list of message fields subset consists of: `content`, `embeds`, `attachments`, `timestamp`, `edited_timestamp` and `flags`.
...
class Message extends Base {
    constructor(data, client) {
        ...
        if(this.type === MessageTypes.CALL) {
