    ...
    constructor(data, client) {
        ...
        switch(this.type) {
            ...
            case MessageTypes.STAGE_START: {
                data.content = `${this.author.mention} started ${this.content}`;
                break;
            }
            case MessageTypes.STAGE_END: {
                data.content = `${this.author.mention} ended ${this.content}`;
                break;
            }
            ...
            case MessageTypes.STAGE_TOPIC: {
                data.content = `${this.author.mention} changed the Stage topic: **${this.content}**`;
                break;
            }
            default: {
