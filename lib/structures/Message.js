    ...
    constructor(data, client) {
        ...
        if(this.guild) {
            if(data.member) {
                ...
                this.member = this.guild.members.update(data.member, this.guild);
    ...
    update(data, client) {
        ...
        if(data.content !== undefined) {
            ...
            this.mentions = data.mentions.map((mention) => {
                ...
                if(mention.member && this.guild) {
                    ...
                    this.guild.members.update(mention.member, this.guild);
                }
                return user;
            });
        ...
        if(data.reactions) {
            data.reactions.forEach((reaction) => {
                ...
                this.reactions.push(new MessageReaction(this.client, reaction));
            });
        }
    }
