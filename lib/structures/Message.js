...
class Message extends Base {
    ...
    * @arg {String} [content.components[].custom_id] The ID of the button
    * @arg {Boolean} [content.components[].disabled] Whether the button is disabled
    * @arg {Object} [content.components[].emoji] The emoji to be displayed in the button
    * @arg {String} [content.components[].label] The label to be displayed in the button
    * @arg {Number} [content.components[].style] The style of the button - If 0-4, `custom_id` is required; if 5, `url` is required
    ...
    * @arg {String} [content.components[].url] The URL that the button should open for users
    ...
    * @arg {String} [options.components[].custom_id] The ID of the button
    * @arg {Boolean} [options.components[].disabled] Whether the button is disabled
    * @arg {Object} [options.components[].emoji] The emoji to be displayed in the button
    * @arg {String} [options.components[].label] The label to be displayed in the button
    * @arg {Number} [options.components[].style] The style of the button - If 0-4, `custom_id` is required; if 5, `url` is required
    * @arg {Number} options.components[].type The type of component - If 1, it is a collection and a `components` array (nested) is required; if 2, it is a button
    * @arg {String} [options.components[].url] The URL that the button should open for users
