...
class Message {
    ...
    update(data, client) {
        ...
        if(data.content !== undefined) {
            ...
            this.mentions = data.mentions.map((mention) => {
                ...
                return client.users.add(mention, client);
            });
    ...
    */
    edit() {
        return this._client.editMessage.apply(this._client, [this.channel.id, this.id].concat(arguments));
    }
    ...
    */
    pin() {
        return this._client.pinMessage.apply(this._client, [this.channel.id, this.id].concat(arguments));
    }
    ...
    */
    unpin() {
        return this._client.unpinMessage.apply(this._client, [this.channel.id, this.id].concat(arguments));
    }
    ...
    */
    delete() {
        return this._client.deleteMessage.apply(this._client, [this.channel.id, this.id].concat(arguments));
    }
}
