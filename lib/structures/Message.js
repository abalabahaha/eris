...
* @prop {Array<Object>} componenets An array of component objects
...
class Message extends Base {
    ...
    update(data, client) {
        ...
        if(data.componenets !== undefined) {
            this.componenets = data.componenets;
        }
    }
    ...
    * @arg {Array<Object>} [content.componenets] A list of component objects.
