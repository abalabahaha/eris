...
* @prop {String} link The link users can use to jump to the message
...
class Message extends Base {
    ...
    get link() {
        return `${Endpoints.CLIENT_URL}${Endpoints.MESSAGE(this.channel.type === 1 ? '@me' : this.channel.guild.id, this.channel.id, this.id)}`;
    }
