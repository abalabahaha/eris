...
class Message extends Base {
    ...
    * @arg {Object | Array<Object>} [options.file] [DEPRECATED] A file object (or an Array of them), use `content.files` instead
    ...
    */
    editWebhook(token, options) {
        ...
        if(options.file) {
            ...
            this.emit("warn", "[DEPRECATED] file is deprecated. Use options.files instead");
        }
