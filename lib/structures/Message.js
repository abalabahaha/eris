...
class Message {
    ...
    toJSON() {
        ...
        excludedKeys = ['_client', 'channel', 'author', '_cleanContent', 'mentions', 'roleMentions', 'channelMentions'];
        ...
        copy.author = this.author.toJSON();
        copy.channelID = this.channel.id;
        copy.cleanContent = this.cleanContent || this._cleanContent;
