    ...
    wsEvent(packet) {
        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_DELETE": {
                ...
                * @prop {Message | Object} message The message object. If the message is not cached, this will be an object with `id` and `channel` keys
                */
            ...
            case "MESSAGE_DELETE_BULK": {
                 ...
                 * @prop {Channel} channel The channel the bulk delete was occurred in
                 * @prop {Object[]} messages Array of message objects
                 */
                this.client.emit("messageDeleteBulk", channel, packet.d.ids.map((id) => (channel.messages.remove({
                    id
                }) || {
                    id: id,
