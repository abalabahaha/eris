    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "GUILD_SCHEDULED_EVENT_UPDATE": {
                ...
                * @prop {Number} oldEvent.entityType The [entity type](https://discord.com/developers/docs/resources/guild-scheduled-event#guild-scheduled-event-object-guild-scheduled-event-entity-types) of the scheduled event
                */
            ...
            case "GUILD_SCHEDULED_EVENT_USER_ADD": {
                ...
                if(!guild) {
                    this.emit("guildScheduledEventUserAdd", packet.d.guild_scheduled_event_id, user);
                    break;
                }
                ...
                */
                this.emit("guildScheduledEventUserAdd", event, user);
                break;
            }
            case "GUILD_SCHEDULED_EVENT_USER_REMOVE": {
                ...
                if(!guild) {
                    this.emit("guildScheduledEventUserRemove", packet.d.guild_scheduled_event_id, user);
                    break;
                }
                ...
                */
                this.emit("guildScheduledEventUserRemove", event, user);
                break;
            }
