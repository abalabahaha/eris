    ...
    */
    ...
    initializeWS() {
        ...
        if(this.sessionID) {
            ...
            this.ws = new WebSocket(this._resumeURL || this.client.gatewayURL, this.client.options.ws);
        } else {
            ...
            case "READY": {
                ...
                if(packet.t === "RESUMED") {
                    ...
                    */
                    ...
                    this._resumeURL = `${packet.d.resume_gateway_url}?v=${Constants.GATEWAY_VERSION}&encoding=${Erlpack ? "etf" : "json"}`;
                    
                    if(this.client.options.compress) {
                        this._resumeURL += "&compress=zlib-stream";
                    }
                }
