        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            case "PRESENCE_UPDATE": {
                if(packet.d.user.username !== undefined) {
                    ...
                    let oldUser = null;
                    if(user && (user.username !== packet.d.user.username || user.discriminator !== packet.d.user.discriminator || user.avatar !== packet.d.user.avatar || user.banner !== packet.d.user.banner || user.bannerColor !== packet.d.user.banner_color)) {
                        oldUser = {
                    ...
                    if(!user || oldUser) {
                        ...
                        * @prop {String?} oldUser.bannerColor The user's banner color, prefixed with a "#", or null if no banner color
                        */
