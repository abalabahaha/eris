    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "CHANNEL_UPDATE": {
                 ...
                 * @prop {Array<String>} oldChannel.appliedTags the IDs of the set of tags that have been applied to a thread in a forum channel (forum channels only, max 5)
                 ...
                 * @prop {Array<Object>} oldChannel.availableTags The available tags that can be applied to threads within a forum channel (forum channels only, max 20)
            ...
            case "THREAD_CREATE": {
                ...
                const parent = channel.guild.channels.find((c) => c.id == channel.parentID);

                if(parent) {
                    channel.guild.channels.update(Object.assign(parent, {last_message_id: channel.id} ));
                }
