  ...
  wsEvent(packet) {
    switch (packet.t) {
      ...
      case "GUILD_UPDATE": {
         ...
         * @prop {Object?} oldGuild.incidentsData The incidents data for the guild
         * @prop {Number?} oldGuild.incidentsData.dmsDisabledUntil When DMs will get enabled again
         * @prop {Number?} oldGuild.incidentsData.dmSpamDetectedAt When the DM spam was detected
         * @prop {Number?} oldGuild.incidentsData.invitesDisabledUntil When invites will get enabled again
         * @prop {Number?} oldGuild.incidentsData.raidDetectedAt When the raid was detected
