    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_REACTION_ADD": {
                ...
                * @prop {Member | String} reactor The member if in a guild or the ID of the user that added the reaction
                */
                this.emit("messageReactionAdd", message || {
                    id: packet.d.message_id,
                    channel: channel || {id: packet.d.channel_id}
                }, packet.d.emoji, packet.d.member ? member : packet.d.user_id);
                break;
            }
