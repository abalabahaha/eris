...
class Shard extends EventEmitter {
    ...
    wsEvent(packet) {
        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "GUILD_ROLE_UPDATE": {
                var guild = this.client.guilds.get(packet.d.guild_id);
                if(!guild) {
                    this.client.emit("warn", `Missing guild ${packet.d.guild_id} in GUILD_ROLE_UPDATE`);
                    break;
                }
    ...
    */
    ...
    /**
    * Returns the ID of the shard instead of the object when converted to a string
    * @returns {String} 
    */
    toString() {
        return this.id;
