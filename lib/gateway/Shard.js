    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_REACTION_ADD": {
                ...
                * @prop {Member | Object} reactor The member, if the reaction is in a guild. If not, or if the member is not cached, this will be an object with an `id` key. No other property is guaranteed
                */
