    ...
    wsEvent(packet) {
        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "USER_GUILD_SETTINGS_UPDATE": {
                if(!this.client.userGuildSettings[packet.d.guild_id]) {
                    console.log("WHAT THE HELL INVALID GUILD SETTINGS ID");
                    break;
                }
    ...
    parse(message) {
        ...
        if(Erlpack) {
            ...
            if(data instanceof ArrayBuffer) {
                ...
                data = Zlib.inflateSync(Buffer.concat(data)).toString();
            }
            try {
