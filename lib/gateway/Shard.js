    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "GUILD_SCHEDULED_EVENT_USER_CREATE": {
                ...
                * @prop {GuildEvent} event The guild event that the user subscribed to. This will be the guild event ID if the guild was uncached
            ...
            case "GUILD_SCHEDULED_EVENT_USER_DELETE": {
                ...
                * @prop {GuildEvent} event The guild event that the user unsubscribed to. This will be the guild event ID if the guild was uncached
