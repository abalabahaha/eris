    ...
    wsEvent(packet) {
        switch(packet.t) {
            ...
            case "MESSAGE_POLL_VOTE_ADD": {
                ...
                } else if(message.poll.results.answer_counts.find((answer) => answer.id === packet.d.answer_id)) {
                    message.poll.results.answer_counts.find((answer) => answer.id === packet.d.answer_id).count++;
                    if(packet.d.user_id === this.client.user.id) {
                        message.poll.results.answer_counts.find((answer) => answer.id === packet.d.answer_id).me_voted = true;
                    }
                } else {
            ...
            case "MESSAGE_POLL_VOTE_REMOVE": {
                ...
                if(!message) {
                    ...
                    message.poll.results.answer_counts.find((answer) => answer.id === packet.d.answer_id).count--;
                    if(packet.d.user_id === this.client.user.id) {
                        message.poll.results.answer_counts.find((answer) => answer.id === packet.d.answer_id).me_voted = false;
                    }
                }
                /**
