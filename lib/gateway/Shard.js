...
class Shard extends EventEmitter {
    ...
    */
    disconnect(options, error) {
        ...
        this.removeAllListeners("readyPacket");
        if(ws) {
            try {
    ...
    wsEvent(packet) {
        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_UPDATE": {
                ...
                * @prop {Object[]} oldMessage.channelID The ID of the channel containing the message
            ...
            case "MESSAGE_DELETE": {
                ...
                * @prop {Message | Object} message The message object. If the message is not cached, this will be an object with `id` and `channelID` keys
                */
            ...
            case "MESSAGE_REACTION_ADD": {
                ...
                * @prop {User} user The user that added the reaction
                */
                this.client.emit("messageReactionAdd", message || {
                    id: packet.d.id,
                    channelID: packet.d.channel_id
                }, packet.d.emoji, this.client.users.get(packet.d.user_id));
                break;
            }
            case "MESSAGE_REACTION_REMOVE": {
                ...
                * @prop {String?} emoji.id The emoji ID (null for non-custom emojis)
                * @prop {String} emoji.name The emoji name
                * @prop {User} user The user that removed the reaction
                */
            ...
            case "VOICE_SERVER_UPDATE": {
                ...
                packet.d.shard = this;
                packet.d.opusOnly = this.client.options.opusOnly;
    ...
    createGuild(_guild) {
        ...
        var guild = this.client.guilds.add(_guild, this.client);
    ...
    initializeWS() {
        ...
        this.ws.onclose = (event) => {
            var options = {
                reconnect: event.code === 1000 ? false : "auto"
            };
