        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_CREATE": {
                ...
                if(channel) { // MESSAGE_CREATE just when deleting o.o
                    ...
                    * @prop {Message} message The message. Can be partial with only the channel_id if the channel is not cached
                    */
            ...
            case "MESSAGE_UPDATE": {
                ...
                * @prop {Message} message The updated message. If oldMessage is null, it is recommended to discard this event, since the message data will be very incomplete (only `id` and `channel` are guaranteed). If the channel isn't cached, `channel` will be an object with only `id`.
            ...
            case "MESSAGE_DELETE": {
                ...
                * @prop {Message | Object} message The message object. If the message is not cached, this will be an object with `id` and `channel` keys. No other property is guaranteed. If the channel is not cached, channel will be an object with only `id`.
                */
