        ...
        switch(packet.t) {
            ...
            case "MESSAGE_POLL_VOTE_ADD": {
                ...
                if(!message) {
                    message = {
                        id: packet.d.message_id,
                        channel: channel || packet.d.channel_id
                    };
                    if(packet.d.guild_id) {
                        message.guildID = packet.d.guild_id;
                        if(!message.channel.guild) {
                 ...
                 */
                this.emit("messagePollVoteAdd", packet.d.answer_id, message, user);
                break;
            }
            case "MESSAGE_POLL_VOTE_REMOVE": {
                 ...
                 */
                this.emit("messagePollVoteRemove", packet.d.answer_id, message, user);
                break;
            }
