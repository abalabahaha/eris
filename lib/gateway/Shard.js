    ...
    wsEvent(packet) {
        switch(packet.t) {
            ...
            case "CHANNEL_UPDATE": {
                 ...
                 * @prop {TextChannel | TextVoiceChannel | CategoryChannel | NewsChannel | GuildChannel | DMChannel} channel The updated channel
                ...
                if(packet.d.type === ChannelTypes.DM || packet.d.type === undefined) {
                    if(this.id === 0) {
                        ...
                        if(channel) {
                             ...
                             * @prop {DMChannel | TextChannel | NewsChannel | TextVoiceChannel | CategoryChannel} channel The channel
                             */
