        ...
        switch(packet.t) {
            case "PRESENCE_UPDATE": {
                ...
                if((!member && packet.d.user.username) || oldPresence) {
                    ...
                    /**
                    * Fired when a guild member status or game changes
            ...
            case "MESSAGE_CREATE": {
                if(packet.d.type <= 1 && packet.d.type >= 5) {
                    break; // These types only exist in group DMs
                }
            ...
            case "CHANNEL_CREATE": {
                if(packet.d.type === undefined || packet.d.type === 1) {
                    ...
                    // Group channels are explicitly ignored
                } else {
            ...
            case "READY": {
                ...
                if(this.client.user.bot) {
                    ...
                    throw new Error("User bots are not allowed by Discord's Terms of Service, please use a bot account.");
                }
