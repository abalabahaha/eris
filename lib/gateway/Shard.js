    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "GUILD_SCHEDULED_EVENT_USER_ADD": {
                ...
                */
                this.emit("guildScheduledEventUserAdd", guild.events.get(packet.d.guild_scheduled_event_id) || {id: packet.d.guild_scheduled_event_id, guild: guild}, user);
                break;
            }
            case "GUILD_SCHEDULED_EVENT_USER_REMOVE": {
                ...
                */
                this.emit("guildScheduledEventUserRemove", guild.events.get(packet.d.guild_scheduled_event_id)  || {id: packet.d.guild_scheduled_event_id, guild: guild}, user);
                break;
            }
