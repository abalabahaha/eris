 ...
 * @prop {Number?} lastHeartbeatReceived Last time Discord acknowledged a heartbeat, null if shard has not recieved heartbeat acknowledgement yet
 * @prop {Number?} lastHeartbeatSent Last time shard sent a heartbeat, null if shard has not sent heartbeat yet
 * @prop {Number} latency The current latency between the shard and Discord in milliseconds, Infinity if shard has not recieved heartbeat acknowledgement yet
