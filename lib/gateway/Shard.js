    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            case "AUTO_MODERATION_ACTION_EXECUTION": {
                ...
                */
                this.emit("autoModerationActionExecution", guild, packet.d);
                break;
            }
            ...
            case "AUTO_MODERATION_RULE_CREATE": {
                ...
                */
                this.emit("autoModerationRuleCreate", guild, packet.d);
                break;
            }
            case "AUTO_MODERATION_RULE_DELETE": {
                ...
                */
                this.emit("autoModerationRuleDelete", guild, packet.d);
                break;
            }
            case "AUTO_MODERATION_RULE_UPDATE": {
                ...
                */
                this.emit("autoModerationRuleUpdate", guild, null, packet.d);
                break;
            }
