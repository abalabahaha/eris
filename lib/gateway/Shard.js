                ...
                switch(packet.op) {
                    ...
                    case OPCodes.HELLO: {
                        if(packet.d.heartbeat_interval > 0) {
                            ...
                            this.heartbeatInterval = setInterval(() => this.heartbeat(true), Math.min(packet.d.heartbeat_interval, 4000)); // Detect lost connections within 30000ms
                        }
