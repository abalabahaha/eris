...
class Shard extends EventEmitter {
    ...
    */
    ...
    getGuildMembers(guildID, timeout) {
        ...
        if(this.client.shards.options.intents) {
            if(!(this.client.shards.options.intents & Constants.Intents.guildMembers)) {
    ...
    requestGuildMembers(guildID, options) {
        ...
        return new Promise((res) => this.requestMembersPromise[opts.nonce] = {
            ...
            }, (options && options.timeout) || this.client.shards.options.requestTimeout)
        });
    }
                ...
                if(guild.pendingVoiceStates && guild.pendingVoiceStates.length > 0) {
                    for(const voiceState of guild.pendingVoiceStates) {
                        ...
                        if(channel) {
                            ...
                            if(this.client.shards.options.seedVoiceConnections && voiceState.id === this.client.user.id && !this.client.voiceConnections.get(channel.guild ? channel.guild.id : "call")) {
