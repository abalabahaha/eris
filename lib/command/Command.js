...
class Command {
    ...
    */
    ...
    process(args, msg) {
        ...
        var subcommand;
        if((subcommand = this.subcommands[label]) !== undefined) {
    ...
    * @arg {String} [options.deleteCommand=false] Whether to delete the user subcommand message or not
    * @arg {String} [options.serverOnly=false] Whether to prevent the subcommand from being used in Direct Messages or not
    ...
    * @arg {String} [options.requirements] A set of factors that limit who can call the subcommand
    * @arg {String} [options.requirements.userIDs] A set of user IDs representing users that can call the subcommand
    * @arg {String} [options.requirements.permissions] An array of permission keys the user must have to use the subcommand
    * i.e.:
    * ```
    * {
    *   "administrator": false,
    ...
    * @arg {String} [options.requirements.roleIDs] An array of role IDs that would allow a user to use the subcommand
    * @arg {String} [options.requirements.roleNames] An array of role names that would allow a user to use the subcommand
    * @returns {Command}
    */
