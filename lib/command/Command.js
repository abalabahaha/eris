...
class Command {
    ...
    */
    ...
    permissionCheck(msg) {
        if(this.requirements.userIDs.length && ~~this.requirements.userIDs.indexOf(msg.author.id)) {
            return false;
        }
        if(!msg.channel.guild && this.serverOnly) {
            return false;
        }
        ...
        if(this.channel.guild) {
            ...
            if(this.requirements.roleIDs.length) {
