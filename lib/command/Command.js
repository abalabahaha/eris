...
class Command {
    ...
    */
    ...
    async permissionCheck(msg) {
        ...
        if(this.requirements.permissions) {
            const requiredPermissions = Object.entries(typeof this.requirements.permissions === "function" ? await this.requirements.permissions(msg) : this.requirements.permissions);
