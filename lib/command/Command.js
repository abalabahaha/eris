...
class Command {
    ...
    * @arg {Array<String>} [options.usage] Details on how to call the command to show in the default help command
    * @arg {Array<String>} [options.example] Shows an example of how the command should be called
    * @arg {String} [options.module] Assigns a module to the command
    */
