...
class CommandClient extends Client {
    ...
    * @returns {CommandClient} A CommandClient object
    */
    constructor(token, options, commandOptions) {
        ...
        this.on("messageCreate", (msg) => {
            ...
            if(msg.author.id !== this.user.id && (!this.commandOptions.ignoreBots || !msg.author.bot) && (msg.prefix = this.checkPrefix(msg))) {
                var args = msg.content.substring(msg.prefix.length).split(" ");
    ...
    */
    ...
    checkPrefix(msg) {
        ...
        if(typeof prefixes === "string") {
            return msg.content.startsWith(prefixes) && prefixes;
