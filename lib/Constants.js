...
module.exports.DefaultMessageNotificationLevel = {
    ALL_MESSAGES:  0,
    ONLY_MENTIONS: 1
};

module.exports.ExplicitContentFilterLevel = {
    DISABLED:              0,
    MEMBERS_WITHOUT_ROLES: 1,
    ALL_MEMBERS:           2
};

module.exports.MFALevel = {
    NONE:     0,
    ELEVATED: 1
};
...
module.exports.PermissionOverwriteType = {
    ROLE: 0,
    USER: 1
};
