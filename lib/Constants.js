...
module.exports.SystemBoostMessages = {
    8: "%user% just boosted the server!",
    9: "%user% just boosted the server! %guild% has achieved **Level 1!**",
    10: "%user% just boosted the server! %guild% has achieved **Level 2!**",
    11: "%user% just boosted the server! %guild% has achieved **Level 3!**"
};
